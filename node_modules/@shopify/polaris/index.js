...
var cssUtilities = require('@shopify/css-utilities');
...
var compose$2 = _interopDefault(require('@shopify/react-compose'));
...
function (_React$PureComponent) {
  ...
  _createClass(Avatar, [{
    ...
    value: function render() {
      ...
      var className = cssUtilities.classNames(styles.Avatar, styles[cssUtilities.variationName('style', styleClass(nameString))], size && styles[cssUtilities.variationName('size', size)], hasImage && !hasLoaded && styles.hidden, hasImage && styles.hasImage);
      var imageMarkUp = finalSource && !isServer && !hasError ? React.createElement(Image, {
...
function Icon(_ref) {
  ...
  var className = cssUtilities.classNames(styles$1.Icon, color && styles$1[cssUtilities.variationName('color', color)], color && color !== 'white' && styles$1.isColored, backdrop && styles$1.hasBackdrop);
...
function Spinner(_ref) {
  ...
  var className = cssUtilities.classNames(styles$2.Spinner, color && styles$2[cssUtilities.variationName('color', color)], size && styles$2[cssUtilities.variationName('size', size)]);
...
function Button(_ref) {
  ...
  var className = cssUtilities.classNames(styles$3.Button, primary && styles$3.primary, outline && styles$3.outline, destructive && styles$3.destructive, isDisabled && styles$3.disabled, loading && styles$3.loading, plain && styles$3.plain, monochrome && styles$3.monochrome, size && size !== DEFAULT_SIZE && styles$3[cssUtilities.variationName('size', size)], fullWidth && styles$3.fullWidth, icon && children == null && styles$3.iconOnly);
...
function wrapWithComponent(element, Component, props) {
  ...
  return isElementOfType(element, Component) ? element : React.createElement(Component, props, element);
...
function elementChildren(children) {
  ...
  return React.Children.toArray(children).filter(function (child) {
    return React.isValidElement(child) && predicate(child);
  });
}
...
function (_React$PureComponent) {
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      ...
      var className = cssUtilities.classNames(styles$4.Item, focused && styles$4['Item-focused'], button.props.plain && styles$4['Item-plain']);
      return React.createElement("div", {
        className: className,
...
function ButtonGroup(_ref) {
  ...
  var className = cssUtilities.classNames(styles$4.ButtonGroup, segmented && styles$4.segmented, fullWidth && styles$4.fullWidth, connectedTop && styles$4.connectedTop);
...
function Item$1(_ref) {
  var children = _ref.children,
      fill = _ref.fill;
  var className = cssUtilities.classNames(styles$5.Item, fill && styles$5['Item-fill']);
  return React.createElement("div", {
    className: className
  }, children);
}
...
function (_React$PureComponent) {
  ...
  _createClass(Stack, [{
    ...
    value: function render() {
      ...
      var className = cssUtilities.classNames(styles$5.Stack, vertical && styles$5.vertical, spacing && styles$5[cssUtilities.variationName('spacing', spacing)], distribution && styles$5[cssUtilities.variationName('distribution', distribution)], alignment && styles$5[cssUtilities.variationName('alignment', alignment)], wrap === false && styles$5.noWrap);
...
function Header(_ref) {
  ...
  var actionMarkup = actions ? React.createElement(ButtonGroup, null, buttonsFrom(actions, {
    plain: true
  })) : null;
...
function Section(_ref) {
  var children = _ref.children,
      ...
      fullWidth = _ref.fullWidth;
  var className = cssUtilities.classNames(styles$7.Section, subdued && styles$7['Section-subdued'], fullWidth && styles$7['Section-fullWidth']);
...
function (_React$PureComponent) {
  ...
  _createClass(Card, [{
    ...
    value: function render() {
      ...
      var className = cssUtilities.classNames(styles$7.Card, subdued && styles$7.subdued);
      var headerMarkup = title || actions ? React.createElement(Header, {
        actions: actions,
        title: title
      }) : null;
...
function TextStyle(_ref) {
  var variation = _ref.variation,
      children = _ref.children;
  var className = cssUtilities.classNames(variation && styles$9[cssUtilities.variationName('variation', variation)], variation === VariationValue.Code && styles$9.code);
...
function (_React$Component) {
  ...
  _createClass(Scrollable, [{
    ...
    value: function render() {
      ...
      var finalClassName = cssUtilities.classNames(className, styles$c.Scrollable, vertical && styles$c.vertical, horizontal && styles$c.horizontal, topShadow && styles$c.hasTopShadow, bottomShadow && styles$c.hasBottomShadow);
...
function Badge(_ref) {
  var children = _ref.children,
      ...
      intl = _ref.polaris.intl;
  var className = cssUtilities.classNames(styles$e.Badge, status && styles$e[cssUtilities.variationName('status', status)], progress && styles$e[cssUtilities.variationName('progress', progress)], size && size !== DEFAULT_SIZE$1 && styles$e[cssUtilities.variationName('size', size)]);
  var progressMarkup;
...
function Item$2(_ref) {
  var id = _ref.id,
      ...
      active = _ref.active,
      role = _ref.role;
  var className = cssUtilities.classNames(styles$f.Item, disabled && styles$f.disabled, destructive && styles$f.destructive, active && styles$f.active);
...
function Checkbox(_ref) {
  var _ref$id = _ref.id,
      ...
      value = _ref.value,
      role = _ref.role;
  var className = cssUtilities.classNames(styles$g.Checkbox, active && styles$g.active);
  return React.createElement("div", {
    className: className
...
function (_React$Component) {
  ...
  _createClass(Option, [{
    ...
    value: function render() {
      ...
      var singleSelectClassName = cssUtilities.classNames(styles$h.SingleSelectOption, focused && styles$h.focused, disabled && styles$h.disabled, select && styles$h.select, active && styles$h.active);
      var multiSelectClassName = cssUtilities.classNames(styles$h.Label, active && styles$h.active);
...
function Pane(_ref) {
  ...
  var className = cssUtilities.classNames(styles$j.Pane, fixed && styles$j['Pane-fixed']);
...
function (_React$PureComponent) {
  ...
  _createClass(PositionedOverlay, [{
    ...
    value: function render() {
      ...
      var className = cssUtilities.classNames(styles$k.PositionedOverlay, fixed && styles$k.fixed);
      return React.createElement("div", {
        className: className,
        style: style,
        ref: this.setOverlay
...
function (_React$PureComponent) {
  ...
  function PopoverOverlay() {
    ...
    _this.renderPopover = function (transitionStatus, overlayDetails) {
      ...
      var className = cssUtilities.classNames(styles$j.Popover, positioning === 'above' && styles$j.positionedAbove, fullWidth && styles$j.fullWidth, measuring && styles$j.measuring);
      _this.transitionStatus = transitionStatus;
      var contentStyles = measuring ? undefined : {
        height: desiredHeight
      };
      var contentClassNames = cssUtilities.classNames(styles$j.Content, fullHeight && styles$j['Content-fullHeight']);
...
function Label(_ref) {
  var children = _ref.children,
      id = _ref.id,
      hidden = _ref.hidden;
  var className = cssUtilities.classNames(styles$l.Label, hidden && styles$l.hidden);
  return React.createElement("div", {
    className: className
...
function Labelled(_a) {
  ...
  var className = cssUtilities.classNames(labelHidden && styles$n.hidden);
...
function (_React$PureComponent) {
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      ...
      var className = cssUtilities.classNames(styles$o.Item, focused && styles$o['Item-focused'], position === ItemPosition.Primary ? styles$o['Item-primary'] : styles$o['Item-connection']);
      return React.createElement("div", {
        onBlur: this.handleBlur,
        onFocus: this.handleFocus,
        className: className
...
function (_React$PureComponent) {
  ...
  _createClass(TextField, [{
    ...
    value: function render() {
      ...
      var className = cssUtilities.classNames(styles$p.TextField, Boolean(normalizedValue) && styles$p.hasValue, disabled && styles$p.disabled, readOnly && styles$p.readOnly, error && styles$p.error, multiline && styles$p.multiline, this.state.focus && styles$p.focus);
      ...
      var characterCountClassName = cssUtilities.classNames(styles$p.CharacterCount, multiline && styles$p.AlignFieldBottom);
      ...
      var clearButtonMarkup = clearButton && normalizedValue !== '' ? React.createElement("button", {
      ...
      var inputClassName = cssUtilities.classNames(styles$p.Input, align && styles$p[cssUtilities.variationName('Input-align', align)], suffix && styles$p['Input-suffixed'], clearButton && styles$p['Input-hasClearButton']);
      ...
      return React.createElement(Labelled, {
        ...
        onBlur: this.handleBlur,
        onClick: this.handleClick
      }, prefixMarkup, input, suffixMarkup, characterCountMarkup, clearButtonMarkup, spinnerMarkup, React.createElement("div", {
...
function (_React$PureComponent) {
  ...
  _createClass(Banner, [{
    ...
    value: function render() {
      ...
      var className = cssUtilities.classNames(styles$s.Banner, status && styles$s[cssUtilities.variationName('status', status)], onDismiss && styles$s.hasDismiss, withinContentContainer ? styles$s.withinContentContainer : styles$s.withinPage);
      var id = uniqueID();
...
function Backdrop(props) {
  ...
  var className = cssUtilities.classNames(styles$t.Backdrop, belowNavigation && styles$t.belowNavigation, transparent && styles$t.transparent);
  return React.createElement(React.Fragment, null, React.createElement(ScrollLock, null), React.createElement("div", {
    className: className,
    onClick: onClick,
...
function TextContainer(_ref) {
  var spacing = _ref.spacing,
      children = _ref.children;
  var className = cssUtilities.classNames(styles$v.TextContainer, spacing && styles$v[cssUtilities.variationName('spacing', spacing)]);
  return React.createElement("div", {
    className: className
  }, children);
}
...
function CalloutCard(_ref) {
  ...
  var imageClassName = cssUtilities.classNames(styles$w.Image, onDismiss && styles$w.DismissImage);
...
function Choice(_ref) {
  var id = _ref.id,
      ...
      helpText = _ref.helpText,
      onClick = _ref.onClick;
  var className = cssUtilities.classNames(styles$y.Choice, labelHidden && styles$y.labelHidden, disabled && styles$y.disabled);
...
function (_React$PureComponent) {
  ...
  _createClass(Checkbox, [{
    ...
    value: function render() {
      ...
      var wrapperClassName = cssUtilities.classNames(styles$z.Checkbox, error && styles$z.error);
      ...
      var inputClassName = cssUtilities.classNames(styles$z.Input, isIndeterminate && styles$z['Input-indeterminate']);
      return (
...
function ChoiceList(_ref) {
  ...
  var className = cssUtilities.classNames(styles$B.ChoiceList, titleHidden && styles$B.titleHidden);
...
function (_React$Component) {
  ...
  _createClass(Collapsible, [{
    ...
    value: function render() {
      ...
      var wrapperClassName = cssUtilities.classNames(styles$C.Collapsible, open && styles$C.open, animating && styles$C.animating, !animating && open && styles$C.fullyOpen);
  ...
  _createClass(Search, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          children = _this$props.children;
      var searchClassName = cssUtilities.classNames(styles$E.Search, visible && styles$E.visible);
      return React.createElement("div", {
        ref: this.node,
...
function (_React$Component) {
  ...
  _createClass(SearchField, [{
    ...
    value: function render() {
      ...
      var className = cssUtilities.classNames(styles$F.SearchField, (focused || active) && styles$F.focused);
      return React.createElement("div", {
        className: className,
        onFocus: this.handleFocus,
        onBlur: this.handleBlur
...
function Link$1(_ref) {
  ...
  var className = cssUtilities.classNames(styles$H.Link, monochrome && styles$H.monochrome);
...
function (_React$PureComponent) {
  ...
  _createClass(TopBar, [{
    ...
    value: function render() {
      ...
      var focused = this.state.focused;
      var className = cssUtilities.classNames(styles$L.NavigationIcon, focused && styles$L.focused);
...
function (_React$Component) {
  ...
  _createClass(Toast, [{
    ...
    value: function render() {
      ...
      var className = cssUtilities.classNames(styles$M.Toast, error && styles$M.error);
      return React.createElement("div", {
        className: className
      }, React.createElement(KeypressListener, {
        keyCode: exports.Key.Escape,
...
var toastClasses = {
  enter: cssUtilities.classNames(styles$N.ToastWrapper, styles$N['ToastWrapper-enter']),
  enterDone: cssUtilities.classNames(styles$N.ToastWrapper, styles$N['ToastWrapper-enter-done']),
  exit: cssUtilities.classNames(styles$N.ToastWrapper, styles$N['ToastWrapper-exit'])
};
...
function Dialog(_a) {
  ...
  var classes = cssUtilities.classNames(styles$P.Modal, large && styles$P.sizeLarge, limitHeight && styles$P.limitHeight);
...
var fadeUpClasses = {
  enter: cssUtilities.classNames(styles$P.animateFadeUp, styles$P.entering),
  enterActive: cssUtilities.classNames(styles$P.animateFadeUp, styles$P.entered),
  exit: cssUtilities.classNames(styles$P.animateFadeUp, styles$P.exiting),
  exitActive: cssUtilities.classNames(styles$P.animateFadeUp, styles$P.exited)
};
...
function Footer(_ref) {
  ...
  var actions = primaryActionButton || secondaryActionButtons ? React.createElement(ButtonGroup, null, secondaryActionButtons, primaryActionButton) : null;
  return React.createElement("div", {
...
function DisplayText(_ref) {
  ...
  var className = cssUtilities.classNames(styles$R.DisplayText, size && styles$R[cssUtilities.variationName('size', size)]);
  return React.createElement(Element, {
    className: className
  }, children);
}
...
function CloseButton(_ref) {
  var _ref$title = _ref.title,
      ...
      onClick = _ref.onClick;
  var className = cssUtilities.classNames(styles$S.CloseButton, !title && styles$S.withoutTitle);
  return React.createElement("button", {
    onClick: onClick,
    className: className
  }, React.createElement(Icon$1, {
...
function Section$3(_ref) {
  ...
  var className = cssUtilities.classNames(styles$U.Section, flush && styles$U.flush, subdued && styles$U.subdued);
  ...
  _createClass(Frame, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          intl = _this$props.polaris.intl;
      var navClassName = cssUtilities.classNames(styles$X.Navigation, showMobileNavigation && styles$X['Navigation-visible']);
      ...
      var skipClassName = cssUtilities.classNames(styles$X.Skip, skipFocused && styles$X.focused);
      ...
      var frameClassName = cssUtilities.classNames(styles$X.Frame, navigation && styles$X.hasNav, topBar && styles$X.hasTopBar);
...
var navTransitionClasses = {
  enter: cssUtilities.classNames(styles$X['Navigation-enter']),
  enterActive: cssUtilities.classNames(styles$X['Navigation-enterActive']),
  enterDone: cssUtilities.classNames(styles$X['Navigation-enterActive']),
  exit: cssUtilities.classNames(styles$X['Navigation-exit']),
  exitActive: cssUtilities.classNames(styles$X['Navigation-exitActive'])
};
var contextualSaveBarTransitionClasses = {
  enter: cssUtilities.classNames(styles$X['ContextualSaveBar-enter']),
  enterActive: cssUtilities.classNames(styles$X['ContextualSaveBar-enterActive']),
  enterDone: cssUtilities.classNames(styles$X['ContextualSaveBar-enterActive']),
  exit: cssUtilities.classNames(styles$X['ContextualSaveBar-exit']),
  exitActive: cssUtilities.classNames(styles$X['ContextualSaveBar-exitActive'])
};
...
function Cell(_ref) {
  ...
  var className = cssUtilities.classNames(styles$Y.Cell, fixed && styles$Y['Cell-fixed'], fixed && truncate && styles$Y['Cell-truncated'], header && styles$Y['Cell-header'], total && styles$Y['Cell-total'], footer && styles$Y['Cell-footer'], numeric && styles$Y['Cell-numeric'], sortable && styles$Y['Cell-sortable'], sorted && styles$Y['Cell-sorted']);
  var headerClassName = cssUtilities.classNames(header && styles$Y.Heading, header && contentType === 'text' && styles$Y['Heading-left']);
  var iconClassName = cssUtilities.classNames(sortable && styles$Y.Icon);
  var style = {
...
function Navigation(_ref) {
  ...
  var pipMarkup = columnVisibilityData.map(function (column, index) {
    var className = cssUtilities.classNames(styles$Y.Pip, column.isVisible && styles$Y['Pip-visible']);
    return React.createElement("div", {
      className: className,
...
function (_React$PureComponent) {
  ...
  function DataTable(props) {
    ...
    _this.defaultRenderRow = function (row, index) {
      var className = cssUtilities.classNames(styles$Y.TableRow);
      var _this$props3 = _this.props,
  ...
  _createClass(DataTable, [{
    ...
    value: function render() {
      ...
      var className = cssUtilities.classNames(styles$Y.DataTable, collapsed && styles$Y.collapsed, footerContent && styles$Y.hasFooter);
      var wrapperClassName = cssUtilities.classNames(styles$Y.TableWrapper, collapsed && styles$Y.collapsed);
      var footerClassName = cssUtilities.classNames(footerContent && styles$Y.TableFoot);
...
function (_React$PureComponent) {
  ...
  _createClass(Day, [{
    ...
    value: function render() {
      ...
      var className = cssUtilities.classNames(styles$Z.Day, selected && styles$Z['Day-selected'], disabled && styles$Z['Day-disabled'], today && styles$Z['Day-today'], (inRange || inHoveringRange) && !disabled && styles$Z['Day-inRange']);
...
function Weekday(_ref) {
  ...
  var className = cssUtilities.classNames(styles$Z.Weekday, current && styles$Z['Weekday-current']);
  return React.createElement("div", {
...
function Month(_ref) {
  ...
  var className = cssUtilities.classNames(styles$Z.Title, current && styles$Z['Month-current']);
...
function (_React$Component) {
  ...
  _createClass(FileUpload, [{
    ...
    value: function render() {
      ...
      var imageClasses = cssUtilities.classNames(styles$$.Image, size && size === 'extraLarge' && styles$$.sizeExtraLarge, size && size === 'large' && styles$$.sizeLarge);
...
function (_React$Component) {
  ...
  _createClass(DropZone, [{
    ...
    value: function render() {
      ...
      var classes = cssUtilities.classNames(styles$10.DropZone, outline && styles$10.hasOutline, (active || dragging) && styles$10.isDragging, error && styles$10.hasError, size && size === 'extraLarge' && styles$10.sizeExtraLarge, size && size === 'large' && styles$10.sizeLarge, size && size === 'medium' && styles$10.sizeMedium, size && size === 'small' && styles$10.sizeSmall);
  ...
  _createClass(EmptyState, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          secondaryAction = _this$props.secondaryAction,
          footerContent = _this$props.footerContent;
      var className = cssUtilities.classNames(styles$12.EmptyState, imageContained && styles$12.imageContained);
...
function ExceptionList(_ref) {
  ...
  var items = itemsList.map(function (item, index) {
    ...
    var itemClasses = cssUtilities.classNames(styles$14.Item, status && styles$14[cssUtilities.variationName('status', status)]);
...
function Group(_ref) {
  var children = _ref.children,
      ...
      title = _ref.title,
      helpText = _ref.helpText;
  var className = cssUtilities.classNames(condensed ? styles$16.condensed : styles$16.grouped);
...
function Section$4(_ref) {
  ...
  var className = cssUtilities.classNames(styles$18.Section, secondary && styles$18['Section-secondary'], fullWidth && styles$18['Section-fullWidth'], oneHalf && styles$18['Section-oneHalf'], oneThird && styles$18['Section-oneThird']);
  return React.createElement("div", {
    className: className
  }, children);
}
...
function (_React$PureComponent) {
  ...
  _createClass(ContentList, [{
    ...
    value: function render() {
      ...
      var className = cssUtilities.classNames(styles$19.List, type && styles$19[cssUtilities.variationName('type', type)]);
...
function Indicator(_ref) {
  ...
  var className = cssUtilities.classNames(styles$1a.Indicator, pulse && styles$1a.pulseIndicator);
  return React.createElement("span", {
    className: className
  });
}
...
function (_React$Component) {
  ...
  _createClass(BaseItem, [{
    ...
    value: function render() {
      ...
      if (url == null) {
        var _className = cssUtilities.classNames(styles$1b.Item, disabled && styles$1b['Item-disabled']);
      ...
      var itemClassName = cssUtilities.classNames(styles$1b.Item, disabled && styles$1b['Item-disabled'], selected && subNavigationItems.length === 0 && styles$1b['Item-selected'], showExpanded && styles$1b.subNavigationActive);
      ...
      var className = cssUtilities.classNames(styles$1b.ListItem, secondaryAction && styles$1b['ListItem-hasAction']);
      return React.createElement("li", {
        className: className
      }, React.createElement(UnstyledLink$1, {
        url: url,
...
function (_React$Component) {
  ...
  _createClass(Section, [{
    ...
    value: function render() {
      ...
      var expanded = this.state.expanded;
      var className = cssUtilities.classNames(styles$1b.Section, separator && styles$1b['Section-withSeparator'], fill && styles$1b['Section-fill']);
      ...
      var toggleClassName = cssUtilities.classNames(styles$1b.Item, styles$1b.RollupToggle);
...
function (_React$PureComponent) {
  ...
  function TooltipOverlay() {
    ...
    _this.renderTooltip = function (overlayDetails) {
      ...
      var containerClassName = cssUtilities.classNames(styles$1c.Tooltip, light && styles$1c.light, measuring && styles$1c.measuring, positioning === 'above' && styles$1c.positionedAbove);
      var contentStyles = measuring ? undefined : {
...
function Pagination(_ref) {
  ...
  var className = cssUtilities.classNames(styles$1d.Pagination, plain && styles$1d.plain);
  var previousClassName = cssUtilities.classNames(styles$1d.Button, styles$1d.PreviousButton);
  var nextClassName = cssUtilities.classNames(styles$1d.Button, styles$1d.NextButton);
...
function Action(_ref) {
  ...
  var className = cssUtilities.classNames(styles$1e.Action, disabled && styles$1e.disabled, icon && children == null && styles$1e.iconOnly);
  return React.createElement("button", {
    key: children,
    className: className,
    onClick: onAction,
...
function (_React$PureComponent) {
  ...
  _createClass(Page, [{
    ...
    value: function render() {
      ...
      var className = cssUtilities.classNames(styles$1h.Page, fullWidth && styles$1h.fullWidth, singleColumn && styles$1h.singleColumn);
...
function (_React$Component) {
  ...
  function DualThumb() {
    ...
    _this.trackWrapper = React.createRef();
    _this.thumbLower = React.createRef();
    _this.thumbUpper = React.createRef();
  ...
  _createClass(DualThumb, [{
    ...
    value: function render() {
      ...
      var ariaDescribedBy = describedBy.length ? describedBy.join(' ') : undefined;
      var trackWrapperClassName = cssUtilities.classNames(styles$1j.TrackWrapper, error && styles$1j.error, disabled && styles$1j.disabled);
      var thumbLowerClassName = cssUtilities.classNames(styles$1j.Thumbs, styles$1j.ThumbLower, disabled && styles$1j.disabled);
      var thumbUpperClassName = cssUtilities.classNames(styles$1j.Thumbs, styles$1j.ThumbUpper, disabled && styles$1j.disabled);
      ...
      var outputLowerClassName = cssUtilities.classNames(styles$1j.Output, styles$1j.OutputLower);
      var outputMarkupLower = !disabled && output ? React.createElement("output", {
        htmlFor: idLower,
      ...
      var outputUpperClassName = cssUtilities.classNames(styles$1j.Output, styles$1j.OutputUpper);
      var outputMarkupUpper = !disabled && output ? React.createElement("output", {
        htmlFor: idUpper,
      ...
      return React.createElement(React.Fragment, null, React.createElement(Labelled, {
        id: id,
        label: label,
        error: error,
        action: labelAction,
        ...
        ref: this.thumbLower
      }), outputMarkupLower, React.createElement("button", {
        id: idUpper,
        ...
        ref: this.thumbUpper
      }), outputMarkupUpper), suffixMarkup)), React.createElement(EventListener, {
        event: "resize",
...
function SingleThumb(props) {
  ...
  var className = cssUtilities.classNames(styles$1k.SingleThumb, error && styles$1k.error, disabled && styles$1k.disabled);
  return React.createElement(Labelled, {
    id: id,
    label: label,
    error: error,
...
function (_React$Component) {
  ...
  _createClass(RangeSlider, [{
    ...
    value: function render() {
      ...
      var sliderType = isDualThumb(value) ? React.createElement(DualThumb, Object.assign({
        value: value
      }, sharedProps)) : React.createElement(SingleThumb, Object.assign({
        value: value
      }, sharedProps));
      return React.createElement("div", {
...
function Select(_ref) {
  ...
  var className = cssUtilities.classNames(styles$1m.Select, error && styles$1m.error, disabled && styles$1m.disabled);
...
function CheckableButton(_ref) {
  var accessibilityLabel = _ref.accessibilityLabel,
      ...
      disabled = _ref.disabled;
  var className = plain ? cssUtilities.classNames(styles$1n.CheckableButton, styles$1n['CheckableButton-plain']) : cssUtilities.classNames(styles$1n.CheckableButton, selectMode && styles$1n['CheckableButton-selectMode'], selected && styles$1n['CheckableButton-selected'], measuring && styles$1n['CheckableButton-measuring']);
  return React.createElement("div", {
    className: className,
    onClick: onToggleAll
  }, React.createElement("div", {
...
function (_React$PureComponent) {
  ...
  _createClass(BulkActionButton, [{
    ...
    value: function render() {
      ...
      var className = cssUtilities.classNames(styles$1o.Button, disabled && styles$1o.disabled);
      return React.createElement("button", {
        className: className,
        onClick: onAction,
        onMouseUp: handleMouseUpByBlurring,
...
var slideClasses = {
  appear: cssUtilities.classNames(styles$1o.Slide, styles$1o['Slide-appear']),
  appearActive: cssUtilities.classNames(styles$1o.Slide, styles$1o['Slide-appearing']),
  enter: cssUtilities.classNames(styles$1o.Slide, styles$1o['Slide-enter']),
  enterActive: cssUtilities.classNames(styles$1o.Slide, styles$1o['Slide-entering']),
  exit: cssUtilities.classNames(styles$1o.Slide, styles$1o['Slide-exit'])
};
var BulkActions =
/*#__PURE__*/
function (_React$PureComponent) {
  ...
  _createClass(BulkActions, [{
    ...
    value: function render() {
      ...
      var cancelButtonClassName = cssUtilities.classNames(styles$1o.Button, styles$1o['Button-cancel'], disabled && styles$1o.disabled);
      ...
      var smallScreenGroup = React.createElement(reactTransitionGroup.Transition, {
        ...
        var smallScreenGroupClassName = cssUtilities.classNames(styles$1o.Group, styles$1o['Group-smallScreen'], styles$1o["Group-".concat(status)]);
        return React.createElement("div", {
      ...
      var largeScreenGroup = React.createElement(reactTransitionGroup.Transition, {
        ...
        var largeScreenGroupClassName = cssUtilities.classNames(styles$1o.Group, styles$1o['Group-largeScreen'], !measuring && styles$1o["Group-".concat(status)], measuring && styles$1o['Group-measuring']);
        return React.createElement("div", {
...
function Tag(_ref) {
  var children = _ref.children,
      ...
      intl = _ref.polaris.intl;
  var className = cssUtilities.classNames(disabled && styles$1p.disabled, styles$1p.Tag);
...
function (_React$Component) {
  ...
  function Item() {
    ...
    _this.buttonOverlay = React.createRef();
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      ...
      var className = cssUtilities.classNames(styles$1s.Item, focused && styles$1s.focused, selectable && styles$1s.selectable, selected && styles$1s.selected, selectMode && styles$1s.selectMode, persistActions && styles$1s.persistActions, focusedInner && styles$1s.focusedInner);
...
function (_React$Component) {
  ...
  _createClass(ResourceList, [{
    ...
    value: function render() {
      ...
      var className = cssUtilities.classNames(styles$1t.ItemWrapper, loading && styles$1t['ItemWrapper-isLoading']);
      var loadingWithoutItemsMarkup = loading && !this.itemsExist() ? React.createElement("div", {
        className: className,
        tabIndex: -1
      }, loadingOverlay) : null;
      var resourceListClassName = cssUtilities.classNames(styles$1t.ResourceList, loading && styles$1t.disabledPointerEvents);
...
var BOTTOM_CLASS_NAMES = {
  enter: cssUtilities.classNames(styles$1u.Bottom, styles$1u.enterBottom),
  enterActive: cssUtilities.classNames(styles$1u.Bottom, styles$1u.enterBottomActive),
  exit: cssUtilities.classNames(styles$1u.Bottom, styles$1u.exitBottom),
  exitActive: cssUtilities.classNames(styles$1u.Bottom, styles$1u.exitBottomActive)
};
var RIGHT_CLASS_NAMES = {
  enter: cssUtilities.classNames(styles$1u.Right, styles$1u.enterRight),
  enterActive: cssUtilities.classNames(styles$1u.Right, styles$1u.enterRightActive),
  exit: cssUtilities.classNames(styles$1u.Right, styles$1u.exitRight),
  exitActive: cssUtilities.classNames(styles$1u.Right, styles$1u.exitRightActive)
};
var Sheet =
/*#__PURE__*/
function (_React$Component) {
  ...
  _createClass(Sheet, [{
    ...
    value: function render() {
      ...
      return React.createElement(Portal, {
        ...
        open: open
      }, children)), React.createElement(KeypressListener, {
        keyCode: exports.Key.Escape,
        handler: onClose
      }), React.createElement(EventListener, {
        event: "resize",
        handler: handleResize
      }), open && React.createElement(Backdrop, {
        transparent: true,
        onClick: onClose
      }));
    }
...
function Container(props) {
  ...
  }, layer.props, overlay.props), React.createElement(TrapFocus, {
    trapping: props.open
  }, React.createElement("div", {
    role: "dialog",
    tabIndex: -1,
...
function (_React$PureComponent) {
  ...
  _createClass(Tab, [{
    ...
    value: function render() {
      ...
      var className = cssUtilities.classNames(styles$1v.Tab, selected && styles$1v['Tab-selected']);
      var tabIndex;
...
function (_React$PureComponent) {
  ...
  function TabMeasurer() {
    ...
    _this.handleMeasurement = function () {
      ...
      var tabMeasurerNode = ReactDOM.findDOMNode(_assertThisInitialized(_this));
  ...
  _createClass(TabMeasurer, [{
    ...
    value: function render() {
      ...
      var classname = cssUtilities.classNames(styles$1v.Tabs, styles$1v.TabMeasurer);
      return React.createElement("div", {
        className: classname,
        ref: this.setContainerNode
      }, React.createElement(EventListener, {
...
function (_React$PureComponent) {
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      var classname = cssUtilities.classNames(styles$1v.Tabs, fitted && styles$1v.fitted, disclosureActivatorVisible && styles$1v.fillSpace);
      var disclosureTabClassName = cssUtilities.classNames(styles$1v.DisclosureTab, disclosureActivatorVisible && styles$1v['DisclosureTab-visible']);
...
function Thumbnail(_ref) {
  var source = _ref.source,
      ...
      _ref$size = _ref.size,
      size = _ref$size === void 0 ? 'medium' : _ref$size;
  var className = cssUtilities.classNames(styles$1w.Thumbnail, size && styles$1w[cssUtilities.variationName('size', size)]);
  return React.createElement("span", {
    className: className
  }, React.createElement(Image, {
    alt: alt,
...
function SkeletonDisplayText(_ref) {
  var _ref$size = _ref.size,
      size = _ref$size === void 0 ? 'medium' : _ref$size;
  var className = cssUtilities.classNames(styles$1x.DisplayText, size && styles$1x[cssUtilities.variationName('size', size)]);
  return React.createElement("div", {
    className: className
  });
}
  ...
  _createClass(SkeletonPage, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          breadcrumbs = _this$props.breadcrumbs,
          intl = _this$props.polaris.intl;
      var className = cssUtilities.classNames(styles$1z.Page, fullWidth && styles$1z.fullWidth, singleColumn && styles$1z.singleColumn);
      var headerClassName = cssUtilities.classNames(styles$1z.Header, breadcrumbs && styles$1z['Header-hasBreadcrumbs'], secondaryActions && styles$1z['Header-hasSecondaryActions']);
...
function renderSecondaryActions(actionCount) {
  ...
  for (var i = 0; i < actionCount; i++) {
    ...
    actions.push(React.createElement("div", {
...
function SkeletonThumbnail(_ref) {
  var _ref$size = _ref.size,
      size = _ref$size === void 0 ? 'medium' : _ref$size;
  var className = cssUtilities.classNames(styles$1A.SkeletonThumbnail, size && styles$1A[cssUtilities.variationName('size', size)]);
  return React.createElement("div", {
    className: className
  });
}
...
function ProgressBar(_ref) {
  var _ref$progress = _ref.progress,
      ...
      size = _ref$size === void 0 ? 'medium' : _ref$size,
      intl = _ref.polaris.intl;
  var className = cssUtilities.classNames(styles$1B.ProgressBar, size && styles$1B[cssUtilities.variationName('size', size)]);
