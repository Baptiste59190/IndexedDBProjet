import { bool, any, func, string, object } from 'prop-types';
import * as React from 'react';
import { createElement, Children, Component, PureComponent, createContext, forwardRef, isValidElement, createRef, Fragment } from 'react';
...
import { Redirect, ButtonGroup as ButtonGroup$1, Button as Button$2, Modal as Modal$2, Loading as Loading$3, TitleBar, ResourcePicker as ResourcePicker$2, Toast as Toast$3 } from '@shopify/app-bridge/actions';
...
if (typeof window !== 'undefined') {
  ...
  window.Polaris.VERSION = '3.16.0';
}

var polarisVersion = '3.16.0';
...
var Polaris = {
	...
	Sheet: {
		warningMessage: "The Sheet component must be used within the Frame component."
	},
	SkeletonPage: {
...
function createThemeContext(theme) {
  ...
  var _theme$logo = theme.logo,
      ...
      subscribe = _theme$subscribe === void 0 ? noop : _theme$subscribe,
      _theme$unsubscribe = theme.unsubscribe,
      unsubscribe = _theme$unsubscribe === void 0 ? noop : _theme$unsubscribe;
  return {
    polarisTheme: {
      logo: logo,
      subscribe: subscribe,
...
function createAppProviderContext() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      subscribe = _ref$subscribe === void 0 ? noop$2 : _ref$subscribe,
      _ref$unsubscribe = _ref.unsubscribe,
      unsubscribe = _ref$unsubscribe === void 0 ? noop$2 : _ref$unsubscribe;
...
function (_React$PureComponent) {
  ...
  _createClass(Avatar, [{
    ...
    value: function render() {
      ...
      var imageMarkUp = finalSource && !isServer && !hasError ? createElement(Image, {
      ...
      var initialsMarkup = initials && !hasImage ? createElement("span", {
    ...
    function (_React$Component) {
      ...
      _createClass(WithRef, [{
        ...
        value: function render() {
          ...
          return createElement(Consumer, null, function (ctx) {
            return createElement(WrappedComponent, Object.assign({}, _this.props, {
...
function compose$1() {
  ...
  return function wrapComponent(OriginalComponent) {
    var Result = compose$2.apply(void 0, wrappingFunctions)(OriginalComponent); // eslint-disable-next-line react/display-name
  ...
  _createClass(UnstyledLink, [{
    ...
    value: function render() {
      var _a = this.props,
          ...
          url = _a.url,
          rest = __rest(_a, ["polaris", "external", "url"]);
      ...
      if (polaris && polaris.link) {
        ...
        if (LinkComponent) {
          var _b = this.props,
              _polaris = _b.polaris,
              _rest = __rest(_b, ["polaris"]);

          return createElement(LinkComponent, Object.assign({}, unstyled.props, _rest));
        }
      }
...
var UnstyledLink$1 = compose$1(withAppProvider(), withRef())(UnstyledLink);
...
function Icon(_ref) {
  ...
  if (source === 'placeholder') {
    contentMarkup = createElement("div", {
      className: styles$1.Placeholder
    });
  } else if (isBundledIcon(source)) {
    SourceComponent = BUNDLED_ICONS[source];
    contentMarkup = createElement(SourceComponent, defaultIconProps);
  } else if (typeof source === 'function') {
    var sourceElement = createElement(SourceComponent, defaultIconProps);
    ...
    contentMarkup = createElement("img", {
...
function Button(_ref) {
  ...
  var className = classNames(styles$3.Button, primary && styles$3.primary, outline && styles$3.outline, destructive && styles$3.destructive, isDisabled && styles$3.disabled, loading && styles$3.loading, plain && styles$3.plain, monochrome && styles$3.monochrome, size && size !== DEFAULT_SIZE && styles$3[variationName('size', size)], fullWidth && styles$3.fullWidth, icon && children == null && styles$3.iconOnly);
  var disclosureIconMarkup = disclosure ? createElement(IconWrapper, null, createElement(Icon$1, {
    source: loading ? 'placeholder' : CaretDownMinor
  })) : null;
  var iconMarkup;

  if (icon) {
    var iconInner = isIconSource(icon) ? createElement(Icon$1, {
      source: loading ? 'placeholder' : icon
    }) : icon;
    iconMarkup = createElement(IconWrapper, null, iconInner);
  }

  var childMarkup = children ? createElement("span", {
    className: styles$3.Text
  }, children) : null;
  var spinnerColor = primary || destructive ? 'white' : 'inkLightest';
  var spinnerSVGMarkup = loading ? createElement("span", {
    className: styles$3.Spinner
  }, createElement(Spinner$1, {
    size: "small",
    color: spinnerColor,
    accessibilityLabel: intl.translate('Polaris.Button.spinnerAccessibilityLabel')
  })) : null;
  var content = iconMarkup || disclosureIconMarkup ? createElement("span", {
    className: styles$3.Content
  }, spinnerSVGMarkup, iconMarkup, childMarkup, disclosureIconMarkup) : createElement("span", {
    className: styles$3.Content
  ...
  if (url) {
    ...
    createElement("a", {
      ...
      className: className,
      "aria-label": accessibilityLabel
    }, content) : createElement(UnstyledLink$1, {
      id: id,
      url: url,
      external: external,
      download: download,
...
function wrapWithComponent(element, Component, props) {
  ...
  return isElementOfType(element, Component) ? element : createElement(Component, props, element);
...
function Item$1(_ref) {
  var children = _ref.children,
      fill = _ref.fill;
  var className = classNames(styles$5.Item, fill && styles$5['Item-fill']);
  return createElement("div", {
    className: className
  }, children);
}
...
function (_React$PureComponent) {
  ...
  _createClass(Stack, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$5.Stack, vertical && styles$5.vertical, spacing && styles$5[variationName('spacing', spacing)], distribution && styles$5[variationName('distribution', distribution)], alignment && styles$5[variationName('alignment', alignment)], wrap === false && styles$5.noWrap);
...
function Header(_ref) {
  ...
  var actionMarkup = actions ? createElement(ButtonGroup, null, buttonsFrom(actions, {
    plain: true
  })) : null;
  var titleMarkup = isValidElement(title) ? title : createElement(Heading, null, title);
  var headingMarkup = actionMarkup || children ? createElement(Stack, {
    alignment: "baseline"
...
function Section(_ref) {
  var children = _ref.children,
      ...
      fullWidth = _ref.fullWidth;
  var className = classNames(styles$7.Section, subdued && styles$7['Section-subdued'], fullWidth && styles$7['Section-fullWidth']);
  var headerMarkup = null;

  if (title) {
    var headerContent = typeof title === 'string' ? createElement(Subheading, null, title) : title;
    headerMarkup = createElement("div", {
      className: styles$7.SectionHeader
    }, headerContent);
  }
...
function (_React$PureComponent) {
  ...
  _createClass(Card, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$7.Card, subdued && styles$7.subdued);
      var headerMarkup = title || actions ? createElement(Header, {
        actions: actions,
        title: title
      }) : null;
      var content = sectioned ? createElement(Section, null, children) : children;
      ...
      var footerMarkup = primaryFooterActionMarkup || secondaryFooterActionMarkup ? createElement("div", {
        className: styles$7.Footer
      }, createElement(ButtonGroup, null, secondaryFooterActionMarkup, primaryFooterActionMarkup)) : null;
      return createElement("div", {
        className: className
...
function TextStyle(_ref) {
  var variation = _ref.variation,
      children = _ref.children;
  var className = classNames(variation && styles$9[variationName('variation', variation)], variation === VariationValue.Code && styles$9.code);
...
function SettingAction(_ref) {
  var action = _ref.action,
      children = _ref.children;
  return createElement("div", {
    className: styles$a.SettingAction
  }, createElement("div", {
    className: styles$a.Setting
...
function AccountConnection(_ref) {
  ...
  var avatarMarkup = connected ? createElement(Avatar$1, {
    accessibilityLabel: "",
    name: accountName,
    initials: initials,
    source: avatarUrl
  ...
  if (title) {
    titleMarkup = createElement("div", null, title);
  } else if (accountName) {
    titleMarkup = createElement("div", null, accountName);
  }

  var detailsMarkup = details ? createElement("div", null, createElement(TextStyle, {
    variation: "subdued"
  }, details)) : null;
  var termsOfServiceMarkup = termsOfService ? createElement("div", {
    className: styles$b.TermsOfService
  }, termsOfService) : null;
  ...
  return createElement(Card, {
    sectioned: true
  }, createElement(SettingAction, {
    action: actionElement
  }, createElement(Stack, null, avatarMarkup, createElement(Stack.Item, {
    fill: true
  }, createElement("div", {
  ...
  _createClass(Scrollable, [{
    ...
    value: function render() {
      ...
      var _a = this.props,
          ...
          polaris = _a.polaris,
          rest = __rest(_a, ["children", "className", "horizontal", "vertical", "shadow", "hint", "onScrolledToBottom", "polaris"]);

      var finalClassName = classNames(className, styles$c.Scrollable, vertical && styles$c.vertical, horizontal && styles$c.horizontal, topShadow && styles$c.hasTopShadow, bottomShadow && styles$c.hasBottomShadow);
...
function Badge(_ref) {
  var children = _ref.children,
      ...
      intl = _ref.polaris.intl;
  var className = classNames(styles$e.Badge, status && styles$e[variationName('status', status)], progress && styles$e[variationName('progress', progress)], size && size !== DEFAULT_SIZE$1 && styles$e[variationName('size', size)]);
  var progressMarkup;
  ...
  var pipMarkup = progress ? createElement("span", {
    className: styles$e.Pip
  }, createElement(VisuallyHidden, null, progressMarkup)) : null;
  var statusMarkup;
  ...
  var statusLabelMarkup = status ? createElement(VisuallyHidden, null, statusMarkup) : null;
  return createElement("span", {
    className: className
...
function Item$2(_ref) {
  var id = _ref.id,
      ...
      active = _ref.active,
      role = _ref.role;
  var className = classNames(styles$f.Item, disabled && styles$f.disabled, destructive && styles$f.destructive, active && styles$f.active);
  ...
  var contentMarkup = helpText ? createElement("div", null, createElement("div", null, contentText), createElement(TextStyle, {
    variation: "subdued"
  }, helpText)) : contentText;
  var badgeMarkup = badge && createElement("span", {
    className: styles$f.BadgeWrapper
  }, createElement(Badge$1, {
    status: badge.status
  }, badge.content));
  var textMarkup = imageElement ? createElement("div", {
  ...
  var scrollMarkup = active ? createElement(Scrollable$1.ScrollTo, null) : null;
  var control = url ? createElement(UnstyledLink$1, {
    id: id,
    url: url,
    onClick: onAction,
    className: className,
    external: external
  }, contentElement) : createElement("button", {
    id: id,
    onClick: onAction,
    className: className,
    disabled: disabled,
...
function Section$1(_ref) {
  ...
  var actionMarkup = section.items.map(function (_a, index) {
    ...
    return createElement(Item$2, Object.assign({
  ...
  var className = section.title ? undefined : styles$f['Section-withoutTitle'];
  var titleMarkup = section.title ? createElement("p", {
    className: styles$f.Title
  }, section.title) : null;
  var sectionRole = actionRole === 'option' ? 'presentation' : undefined;
  var sectionMarkup = createElement("div", {
    className: className
  }, titleMarkup, createElement("ul", {
    className: styles$f.Actions,
    role: sectionRole
  }, actionMarkup));
  return hasMultipleSections ? createElement("li", {
...
function ActionList(_ref) {
  ...
  var sectionMarkup = finalSections.map(function (section, index) {
    return createElement(Section$1, {
...
function Checkbox(_ref) {
  var _ref$id = _ref.id,
      ...
      value = _ref.value,
      role = _ref.role;
  var className = classNames(styles$g.Checkbox, active && styles$g.active);
  return createElement("div", {
    className: className
  }, createElement("input", {
    id: id,
...
function (_React$Component) {
  ...
  _createClass(Option, [{
    ...
    value: function render() {
      ...
      var focused = this.state.focused;
      var mediaMarkup = media ? createElement("div", {
        className: styles$h.Media
      }, media) : null;
      var singleSelectClassName = classNames(styles$h.SingleSelectOption, focused && styles$h.focused, disabled && styles$h.disabled, select && styles$h.select, active && styles$h.active);
      var multiSelectClassName = classNames(styles$h.Label, active && styles$h.active);
      var checkBoxRole = role === 'option' ? 'presentation' : undefined;
      var optionMarkup = allowMultiple ? createElement("label", {
        htmlFor: id,
        ...
        role: checkBoxRole
      })), mediaMarkup, label) : createElement("button", {
        id: id,
        type: "button",
  ...
  _createClass(OptionList, [{
    ...
    value: function render() {
      ...
      var optionsMarkup = optionsExist ? normalizedOptions.map(function (_ref2, sectionIndex) {
        ...
        var titleMarkup = title ? createElement("p", {
        ...
        var optionsMarkup = options && options.map(function (option, optionIndex) {
          ...
          return createElement(Option, Object.assign({}, option, {
            key: id,
            id: id,
...
var getUniqueID$1 = createUniqueIDFactory('portal-');
  ...
  _createClass(Portal, [{
    ...
    value: function componentDidUpdate(_, prevState) {
      var _this$props$onPortalC = this.props.onPortalCreated,
          onPortalCreated = _this$props$onPortalC === void 0 ? noop$3 : _this$props$onPortalC;
...
var styles$j = {
  ...
  "entering": "Polaris-Popover--entering",
  "entered": "Polaris-Popover--entered",
  "exiting": "Polaris-Popover--exiting",
  "exited": "Polaris-Popover--exited",
...
function Pane(_ref) {
  ...
  var className = classNames(styles$j.Pane, fixed && styles$j['Pane-fixed']);
  var content = sectioned ? wrapWithComponent(children, Section$2, {}) : children;
  return fixed ? createElement("div", {
    className: className
  }, content) : createElement(Scrollable$1, {
    hint: true,
    shadow: true,
    className: className,
...
function (_React$PureComponent) {
  ...
  _createClass(PositionedOverlay, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$k.PositionedOverlay, fixed && styles$k.fixed);
      return createElement("div", {
        className: className,
        style: style,
        ref: this.setOverlay
  ...
  function PopoverOverlay() {
    ...
    _this.renderOverlay = function (transitionStatus) {
      var _this$props = _this.props,
          ...
          preferredAlignment = _this$props$preferred2 === void 0 ? 'center' : _this$props$preferred2,
          fixed = _this$props.fixed;
      return createElement(PositionedOverlay, {
        fullWidth: fullWidth,
        active: active,
        activator: activator,
        preferredPosition: preferredPosition,
        preferredAlignment: preferredAlignment,
        render: _this.renderPopover.bind(_assertThisInitialized(_this), transitionStatus),
        fixed: fixed,
    ...
    _this.renderPopover = function (transitionStatus, overlayDetails) {
      ...
      var className = classNames(styles$j.Popover, positioning === 'above' && styles$j.positionedAbove, fullWidth && styles$j.fullWidth, measuring && styles$j.measuring);
      _this.transitionStatus = transitionStatus;
      var contentStyles = measuring ? undefined : {
        height: desiredHeight
      };
      var contentClassNames = classNames(styles$j.Content, fullHeight && styles$j['Content-fullHeight']);
      ...
      return createElement("div", Object.assign({
        className: className
      }, overlay.props), createElement(EventListener, {
        event: "click",
        handler: _this.handleClick
      }), createElement(EventListener, {
        event: "touchstart",
        handler: _this.handleClick
      }), createElement(KeypressListener, {
        keyCode: Key.Escape,
        handler: _this.handleEscape
      }), createElement("div", {
        className: styles$j.FocusTracker // eslint-disable-next-line jsx-a11y/no-noninteractive-tabindex
        ,
        tabIndex: 0,
  ...
  _createClass(PopoverOverlay, [{
    ...
    value: function render() {
      ...
      return createElement(CSSTransition, {
        ...
        unmountOnExit: true,
        classNames: {
          enter: styles$j.entering,
          enterActive: styles$j.entered,
          exit: styles$j.exiting,
          exitActive: styles$j.exited
        }
      }, this.renderOverlay);
    }
  }, {
...
var getUniqueID$2 = createUniqueIDFactory('Popover');
...
function (_React$PureComponent) {
  ...
  _createClass(Popover, [{
    ...
    value: function render() {
      ...
      var portal = activatorNode ? createElement(Portal, {
        idPrefix: "popover"
      }, createElement(PopoverOverlay, Object.assign({
        id: this.id,
      ...
      }, Children.only(this.props.activator), portal);
    }
  }, {
...
function Label(_ref) {
  var children = _ref.children,
      id = _ref.id,
      hidden = _ref.hidden;
  var className = classNames(styles$l.Label, hidden && styles$l.hidden);
  return createElement("div", {
    className: className
  }, createElement("label", {
    id: labelID(id),
...
function Labelled(_a) {
  ...
  var className = classNames(labelHidden && styles$n.hidden);
  var actionMarkup = action ? createElement("div", {
    className: styles$n.Action
  }, buttonFrom(action, {
    plain: true
  })) : null;
  var helpTextMarkup = helpText ? createElement("div", {
    className: styles$n.HelpText,
    id: helpTextID(id)
  }, helpText) : null;
  var errorMarkup = error && typeof error !== 'boolean' && createElement("div", {
    className: styles$n.Error
  }, createElement(InlineError, {
    message: error,
    fieldID: id
  }));
  var labelMarkup = label ? createElement("div", {
...
function (_React$PureComponent) {
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$o.Item, focused && styles$o['Item-focused'], position === ItemPosition.Primary ? styles$o['Item-primary'] : styles$o['Item-connection']);
      return createElement("div", {
        onBlur: this.handleBlur,
        onFocus: this.handleFocus,
        className: className
...
function Connected(_ref) {
  ...
  var leftConnectionMarkup = left ? createElement(Item$3, {
    position: ItemPosition.Left
  }, left) : null;
  var rightConnectionMarkup = right ? createElement(Item$3, {
    position: ItemPosition.Right
  }, right) : null;
  return createElement("div", {
    className: styles$o.Connected
  }, leftConnectionMarkup, createElement(Item$3, {
...
function (_React$PureComponent) {
  ...
  function Resizer() {
    ...
    _this.contentNode = createRef();
    _this.minimumLinesNode = createRef();
  ...
  _createClass(Resizer, [{
    ...
    value: function render() {
      ...
      var minimumLinesMarkup = minimumLines ? createElement("div", {
...
function (_React$PureComponent) {
  ...
  _createClass(TextField, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$p.TextField, Boolean(normalizedValue) && styles$p.hasValue, disabled && styles$p.disabled, readOnly && styles$p.readOnly, error && styles$p.error, multiline && styles$p.multiline, this.state.focus && styles$p.focus);
      var inputType = type === 'currency' ? 'text' : type;
      var prefixMarkup = prefix ? createElement("div", {
        className: styles$p.Prefix,
        id: "".concat(id, "Prefix")
      }, prefix) : null;
      var suffixMarkup = suffix ? createElement("div", {
      ...
      var characterCountClassName = classNames(styles$p.CharacterCount, multiline && styles$p.AlignFieldBottom);
      var characterCountText = !maxLength ? characterCount : "".concat(characterCount, "/").concat(maxLength);
      var characterCountMarkup = showCharacterCount ? createElement("div", {
      ...
      var clearButtonMarkup = clearButton && normalizedValue !== '' ? createElement("button", {
      ...
      var spinnerMarkup = type === 'number' && !disabled && !readOnly ? createElement(Spinner$2, {
      ...
      var resizer = multiline ? createElement(Resizer, {
      ...
      var inputClassName = classNames(styles$p.Input, align && styles$p[variationName('Input-align', align)], suffix && styles$p['Input-suffixed'], clearButton && styles$p['Input-hasClearButton']);
      var input = createElement(multiline ? 'textarea' : 'input', {
        name: name,
        id: id,
        disabled: disabled,
        readOnly: readOnly,
      ...
      return createElement(Labelled, {
        ...
        onBlur: this.handleBlur,
        onClick: this.handleClick
      }, prefixMarkup, input, suffixMarkup, characterCountMarkup, clearButtonMarkup, spinnerMarkup, createElement("div", {
        className: styles$p.Backdrop
      }), resizer)));
    }
  }], [{
    key: "getDerivedStateFromProps",
...
function (_React$PureComponent) {
  ...
  _createClass(TextField, [{
    ...
    value: function render() {
      ...
      return createElement(TextField$1, Object.assign({}, this.props, {
        autoComplete: false,
...
function (_React$PureComponent) {
  ...
  _createClass(ComboBox, [{
    ...
    value: function render() {
      ...
      var actionsBeforeMarkup = actionsBefore && actionsBefore.length > 0 && createElement(ActionList, {
        actionRole: "option",
        items: actionsBefore
      });
      var actionsAfterMarkup = actionsAfter && actionsAfter.length > 0 && createElement(ActionList, {
        actionRole: "option",
        items: actionsAfter
      });
      var optionsMarkup = options.length > 0 && createElement(OptionList$1, {
        role: "presentation",
        optionRole: "option",
      ...
      var emptyStateMarkup = !actionsAfter && !actionsBefore && !contentAfter && !contentBefore && options.length === 0 && emptyState && createElement("div", {
...
function TextField$3(props) {
  return createElement(ComboBox.TextField, props);
}
  ...
  _createClass(Autocomplete, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          intl = _this$props.polaris.intl;
      var spinnerMarkup = loading ? createElement("div", {
...
function (_React$PureComponent) {
  ...
  _createClass(Banner, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$s.Banner, status && styles$s[variationName('status', status)], onDismiss && styles$s.hasDismiss, withinContentContainer ? styles$s.withinContentContainer : styles$s.withinPage);
      var id = uniqueID();
      ...
      if (title) {
        ...
        headingMarkup = createElement("div", {
      ...
      var actionMarkup = action ? createElement("div", {
        className: styles$s.Actions
      }, createElement(ButtonGroup, null, createElement("div", {
        className: styles$s.PrimaryAction
      }, buttonFrom(action, {
        outline: true,
      ...
      var dismissButton = onDismiss ? createElement("div", {
        className: styles$s.Dismiss
      ...
      }, dismissButton, createElement("div", {
        className: styles$s.Ribbon
      }, createElement(Icon$1, {
        source: iconName,
        color: color,
        backdrop: true
      })), createElement("div", null, headingMarkup, contentMarkup));
    }
  }]);
...
function secondaryActionFrom(action) {
  if (action.url) {
    return createElement(UnstyledLink$1, {
      className: styles$s.SecondaryAction,
      url: action.url,
...
ScrollLock.contextTypes = polarisAppProviderContextTypes;
...
function Backdrop(props) {
  ...
  var className = classNames(styles$t.Backdrop, belowNavigation && styles$t.belowNavigation, transparent && styles$t.transparent);
  return createElement(Fragment, null, createElement(ScrollLock, null), createElement("div", {
    className: className,
    onClick: onClick,
...
function (_React$PureComponent) {
  ...
  _createClass(Breadcrumbs, [{
    ...
    value: function render() {
      ...
      var contentMarkup = createElement(Fragment, null, createElement("span", {
      ...
      var breadcrumbMarkup = 'url' in breadcrumb ? createElement(UnstyledLink$1, {
        key: content,
        url: breadcrumb.url,
        className: styles$u.Breadcrumb,
        onMouseUp: handleMouseUpByBlurring
      }, contentMarkup) : createElement("button", {
        key: content,
        className: styles$u.Breadcrumb,
...
function TextContainer(_ref) {
  var spacing = _ref.spacing,
      children = _ref.children;
  var className = classNames(styles$v.TextContainer, spacing && styles$v[variationName('spacing', spacing)]);
  return createElement("div", {
    className: className
  }, children);
}
...
function CalloutCard(_ref) {
  ...
  var buttonMarkup = secondaryActionMarkup ? createElement(ButtonGroup, null, primaryActionMarkup, secondaryActionMarkup) : primaryActionMarkup;
  var dismissButton = onDismiss ? createElement("div", {
    className: styles$w.Dismiss
  }, createElement(Button$1, {
    plain: true,
    icon: CancelSmallMinor,
    onClick: onDismiss,
  ...
  var imageClassName = classNames(styles$w.Image, onDismiss && styles$w.DismissImage);
  return createElement(Card, null, createElement("div", {
    className: styles$w.Container
  }, dismissButton, createElement(Card.Section, null, createElement("div", {
    className: styles$w.CalloutCard
  }, createElement("div", {
    className: styles$w.Content
  }, createElement("div", {
    className: styles$w.Title
  }, createElement(Heading, null, title)), createElement(TextContainer, null, children), createElement("div", {
    className: styles$w.Buttons
  }, buttonMarkup)), createElement(Image, {
    alt: "",
...
function Choice(_ref) {
  var id = _ref.id,
      ...
      helpText = _ref.helpText,
      onClick = _ref.onClick;
  var className = classNames(styles$y.Choice, labelHidden && styles$y.labelHidden, disabled && styles$y.disabled);
  var labelMarkup = createElement("label", {
    className: className,
    htmlFor: id,
    onClick: onClick
  }, createElement("span", {
  ...
  var helpTextMarkup = helpText ? createElement("div", {
    className: styles$y.HelpText,
    id: helpTextID$1(id)
  }, helpText) : null;
  var errorMarkup = error && typeof error !== 'boolean' && createElement("div", {
    className: styles$y.Error
  }, createElement(InlineError, {
    message: error,
    fieldID: id
  }));
  var descriptionMarkup = helpTextMarkup || errorMarkup ? createElement("div", {
    className: styles$y.Descriptions
  }, errorMarkup, helpTextMarkup) : null;
  return descriptionMarkup ? createElement("div", null, labelMarkup, descriptionMarkup) : labelMarkup;
}
...
function (_React$PureComponent) {
  ...
  _createClass(Checkbox, [{
    ...
    value: function render() {
      ...
      var wrapperClassName = classNames(styles$z.Checkbox, error && styles$z.error);
      ...
      var inputClassName = classNames(styles$z.Input, isIndeterminate && styles$z['Input-indeterminate']);
      return (
        ...
        createElement(Choice, {
          ...
          role: "checkbox"
        }, indeterminateAttributes)), createElement("span", {
...
function ChoiceList(_ref) {
  ...
  var className = classNames(styles$B.ChoiceList, titleHidden && styles$B.titleHidden);
  var titleMarkup = title ? createElement("legend", {
  ...
  var choicesMarkup = choices.map(function (choice) {
    ...
    var children = renderedChildren ? createElement("div", {
      className: styles$B.ChoiceChildren
    }, renderedChildren) : null;
    return createElement("li", {
      key: value
    }, createElement(ControlComponent, {
      name: finalName,
      value: value,
      label: label,
      disabled: disabled,
  ...
  var errorMarkup = error && createElement("div", {
    className: styles$B.ChoiceError
  }, createElement(InlineError, {
    message: error,
    fieldID: finalName
  }));
...
function (_React$Component) {
  ...
  _createClass(Collapsible, [{
    ...
    value: function render() {
      ...
      var wrapperClassName = classNames(styles$C.Collapsible, open && styles$C.open, animating && styles$C.animating, !animating && open && styles$C.fullyOpen);
...
function (_React$PureComponent) {
  ...
  _createClass(Slidable, [{
    ...
    value: function render() {
      ...
      var moveListener = dragging ? createElement(EventListener, {
        event: "mousemove",
        handler: this.handleMove,
        passive: false
      }) : null;
      var touchMoveListener = dragging ? createElement(EventListener, {
        event: "touchmove",
        handler: this.handleMove,
        passive: false
      }) : null;
      var endDragListener = dragging ? createElement(EventListener, {
        event: "mouseup",
        handler: this.handleDragEnd
      }) : null;
      var touchEndListener = dragging ? createElement(EventListener, {
        event: "touchend",
        handler: this.handleDragEnd
      }) : null;
      var touchCancelListener = dragging ? createElement(EventListener, {
        event: "touchcancel",
        handler: this.handleDragEnd
      }) : null;
      return createElement("div", {
        ref: this.setNode,
        className: styles$D.Slidable,
        onMouseDown: this.startDrag,
        onTouchStart: this.startDrag
      }, endDragListener, moveListener, touchMoveListener, touchEndListener, touchCancelListener, createElement("div", {
        style: draggerPositioning,
        className: styles$D.Dragger,
...
function (_React$PureComponent) {
  ...
  _createClass(AlphaPicker, [{
    ...
    value: function render() {
      ...
      return createElement("div", {
        className: styles$D.AlphaPicker,
        ref: this.setSliderHeight
      }, createElement("div", {
        className: styles$D.ColorLayer,
        style: {
          background: background
        }
      }), createElement(Slidable, {
        draggerY: draggerY,
        draggerX: 0,
        onChange: this.handleChange,
...
function (_React$PureComponent) {
  ...
  _createClass(ColorPicker, [{
    ...
    value: function render() {
      ...
      var alphaSliderMarkup = allowAlpha ? createElement(AlphaPicker, {
        alpha: alpha,
        color: color,
        onChange: this.handleAlphaChange
      }) : null;
      return createElement("div", {
        className: styles$D.ColorPicker,
        id: id
      }, createElement("div", {
        ref: this.setColorNode,
        className: styles$D.MainColor
      }, createElement("div", {
        className: styles$D.ColorLayer,
        style: {
  ...
  _createClass(Search, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          children = _this$props.children;
      var searchClassName = classNames(styles$E.Search, visible && styles$E.visible);
      return createElement("div", {
        ref: this.node,
  ...
  function SearchField() {
    ...
    _this.handleClear = function () {
      var _this$props = _this.props,
          ...
          onCancel = _this$props$onCancel === void 0 ? noop$6 : _this$props$onCancel,
          onChange = _this$props.onChange;
  ...
  _createClass(SearchField, [{
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          placeholder = _this$props2.placeholder,
          intl = _this$props2.polaris.intl;
      var clearMarkup = value !== '' && createElement("button", {
        type: "button",
        "aria-label": intl.translate('Polaris.TopBar.SearchField.clearButtonLabel'),
        className: styles$F.Clear,
        onClick: this.handleClear
      }, createElement(Icon$1, {
        source: CircleCancelMinor
      }));
      var className = classNames(styles$F.SearchField, (focused || active) && styles$F.focused);
      return createElement("div", {
        className: className,
        onFocus: this.handleFocus,
        onBlur: this.handleBlur
      ...
      _createClass(WithContext, [{
        ...
        value: function render() {
          ...
          return createElement(Consumer, null, function (ctx) {
            ...
            return createElement(WrappedComponent, Object.assign({}, rest, {
...
var UserMenuContext = createContext({});
...
function (_React$Component) {
  ...
  function Provider(props) {
    ...
    _this.setMobileUserMenuProps = _this.setMobileUserMenuProps.bind(_assertThisInitialized(_this));
    _this.state = {
  ...
  _createClass(Provider, [{
    ...
    value: function render() {
      ...
      var children = this.props.children;
      return createElement(UserMenuContext.Provider, {
        value: state
      }, children);
    }
  }, {
...
var UserMenuConsumer = UserMenuContext.Consumer;
...
var UserMenuModifier = withContext(UserMenuConsumer)(Modifier);
...
function MessageIndicator(_ref) {
  var children = _ref.children,
      active = _ref.active;
  var indicatorMarkup = active && createElement("div", {
    className: styles$G.MessageIndicator
  });
  return createElement("div", {
    className: styles$G.MessageIndicatorWrapper
...
function Link$1(_ref) {
  ...
  var className = classNames(styles$H.Link, monochrome && styles$H.monochrome);
  ...
  if (external && typeof children === 'string') {
    ...
    childrenMarkup = createElement(Fragment, null, children, createElement("span", {
      className: styles$H.IconLockup
    }, createElement("span", {
      className: styles$H.IconLayout
    }, createElement(Icon$1, {
  ...
  return url ? createElement(UnstyledLink$1, {
    onClick: onClick,
    className: className,
    url: url,
    external: external,
    id: id,
    polaris: polaris
  }, childrenMarkup) : createElement("button", {
    type: "button",
    onClick: onClick,
    className: className,
    id: id
...
function Message(_ref) {
  var title = _ref.title,
      ...
      link = _ref.link,
      badge = _ref.badge;
  var badgeMarkup = badge && createElement(Badge$1, {
    status: badge.status
  }, badge.content);
  var to = link.to,
  ...
  }, createElement(Popover.Section, null, createElement(Stack, {
    vertical: true,
    spacing: "tight"
  }, createElement(TextContainer, null, createElement(Heading, null, title, badgeMarkup), createElement("p", null, description)), createElement(Link$2, {
    url: to
  }, linkContent), createElement(Button$1, {
    plain: true,
    onClick: onClick
  }, actionContent))));
}
...
function Menu(props) {
  ...
  var messageMarkup = message && createElement(Message, {
    title: message.title,
  ...
  return createElement(Popover, {
    activator: createElement("div", {
      className: styles$J.ActivatorWrapper
    }, createElement("button", {
      type: "button",
      className: styles$J.Activator,
      onClick: onOpen
    }, activatorContent)),
    active: open,
    onClose: onClose,
...
function UserMenu(_ref) {
  ...
  var activatorContentMarkup = createElement(Fragment, null, createElement(MessageIndicator, {
    active: showIndicator
  }, createElement(Avatar$1, {
    size: "small",
    source: avatar,
    ...
    className: styles$K.Name
  }, name), createElement("p", {
    className: styles$K.Detail
  }, detail)));
...
function UserMenu$1(_a) {
  var _a$context = _a.context,
      ...
      userMenuProps = __rest(_a, ["context"]);

  if (mobileUserMenuProps && mobileView) {
    return createElement(UserMenu, mobileUserMenuProps);
  }

  return createElement(UserMenu, userMenuProps);
}

var UserMenu$2 = withContext(UserMenuConsumer)(UserMenu$1);
...
function (_React$PureComponent) {
  ...
  _createClass(TopBar, [{
    ...
    value: function render() {
      ...
      var focused = this.state.focused;
      var className = classNames(styles$L.NavigationIcon, focused && styles$L.focused);
      var navigationButtonMarkup = showNavigationToggle ? createElement("button", {
        type: "button",
        className: className,
      ...
      if (contextControl) {
        contextMarkup = createElement("div", {
          className: styles$L.ContextControl
        }, contextControl);
      } else if (logo) {
        contextMarkup = createElement("div", {
          className: styles$L.LogoContainer
        }, createElement(UnstyledLink$1, {
          url: logo.url || '',
          className: styles$L.LogoLink,
          style: {
            width: width
          }
        }, createElement(Image, {
      ...
      var searchResultsMarkup = searchResults && searchResultsVisible ? createElement(Search, {
        visible: searchResultsVisible,
        onDismiss: onSearchResultsDismiss
      }, searchResults) : null;
      var searchMarkup = searchField ? createElement(Fragment, null, searchField, searchResultsMarkup) : null;
      return createElement("div", {
        className: styles$L.TopBar
      }, navigationButtonMarkup, contextMarkup, createElement("div", {
        className: styles$L.Contents
      }, createElement("div", {
        className: styles$L.SearchField
      }, searchMarkup), createElement("div", {
        className: styles$L.SecondaryMenu
  ...
  _createClass(Toast, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          action = _this$props.action;
      var dismissMarkup = createElement("button", {
        type: "button",
        className: styles$M.CloseButton,
        onClick: onDismiss
      }, createElement(Icon$1, {
      ...
      var className = classNames(styles$M.Toast, error && styles$M.error);
      return createElement("div", {
        className: className
      }, createElement(KeypressListener, {
        keyCode: Key.Escape,
  ...
  _createClass(ToastManager, [{
    ...
    value: function render() {
      ...
      var toastsMarkup = toastMessages.map(function (toast, index) {
        _this2.toastNodes[index] = createRef();
        return createElement(CSSTransition, {
          key: toast.id,
          timeout: {
            enter: 0,
      ...
      return createElement(Portal, {
        ...
        className: styles$N.ToastManager
...
var toastClasses = {
  enter: classNames(styles$N.ToastWrapper, styles$N['ToastWrapper-enter']),
  enterDone: classNames(styles$N.ToastWrapper, styles$N['ToastWrapper-enter-done']),
  exit: classNames(styles$N.ToastWrapper, styles$N['ToastWrapper-exit'])
};
...
function transformAction(appBridge, action) {
  var style = action.destructive === true ? Button$2.Style.Danger : undefined;
  var button = Button$2.create(appBridge, {
  ...
  if (action.onAction) {
    button.subscribe(Button$2.Action.CLICK, action.onAction);
  }

  var redirect = generateRedirect(appBridge, action.url, action.target, action.external);

  if (redirect != null) {
    button.subscribe(Button$2.Action.CLICK, redirect);
  }
...
function Dialog(_a) {
  ...
  var classes = classNames(styles$P.Modal, large && styles$P.sizeLarge, limitHeight && styles$P.limitHeight);
  var TransitionChild = instant ? Transition : FadeUp;
  return createElement(TransitionChild, Object.assign({}, props, {
    mountOnEnter: true,
    unmountOnExit: true,
    timeout: durationBase,
    onEntered: onEntered,
    onExited: onExited
  }), createElement(DialogContainer, null, createElement(TrapFocus, null, createElement("div", {
    className: classes,
    role: "dialog",
...
var fadeUpClasses = {
  enter: classNames(styles$P.animateFadeUp, styles$P.entering),
  enterActive: classNames(styles$P.animateFadeUp, styles$P.entered),
  exit: classNames(styles$P.animateFadeUp, styles$P.exiting),
  exitActive: classNames(styles$P.animateFadeUp, styles$P.exited)
};
...
function FadeUp(_a) {
  ...
  return createElement(CSSTransition, Object.assign({}, props, {
...
function Footer(_ref) {
  ...
  var actions = primaryActionButton || secondaryActionButtons ? createElement(ButtonGroup, null, secondaryActionButtons, primaryActionButton) : null;
  return createElement("div", {
...
function DisplayText(_ref) {
  ...
  var className = classNames(styles$R.DisplayText, size && styles$R[variationName('size', size)]);
  return createElement(Element, {
    className: className
  }, children);
}
...
function CloseButton(_ref) {
  var _ref$title = _ref.title,
      ...
      onClick = _ref.onClick;
  var className = classNames(styles$S.CloseButton, !title && styles$S.withoutTitle);
  return createElement("button", {
    onClick: onClick,
    className: className
  }, createElement(Icon$1, {
...
function Header$1(_ref) {
  ...
  return createElement("div", {
    ...
    element: "h2",
    size: "small"
  }, children)), createElement(CloseButton, {
    onClick: onClose
  }));
}
...
function Section$3(_ref) {
  ...
  var className = classNames(styles$U.Section, flush && styles$U.flush, subdued && styles$U.subdued);
...
var getUniqueID$7 = createUniqueIDFactory('modal-header');
...
function (_React$Component) {
  ...
  _createClass(Modal, [{
    ...
    value: function componentDidMount() {
      ...
      this.appBridgeModal = Modal$2.create(this.props.polaris.appBridge, this.transformProps());
    ...
    value: function render() {
      ...
      if (open) {
        var footerMarkup = !footer && !primaryAction && !secondaryActions ? null : createElement(Footer, {
          primaryAction: primaryAction,
          secondaryActions: secondaryActions
        }, footer);
        var content = sectioned ? wrapWithComponent(children, Section$3, {}) : children;
        var body = loading ? createElement("div", {
          className: styles$V.Spinner
        }, createElement(Spinner$1, null)) : content;
        var bodyMarkup = src ? createElement("iframe", {
          name: iFrameName,
          title: iframeTitle,
          src: src,
          className: styles$V.IFrame,
          onLoad: this.handleIFrameLoad,
          style: {
            height: "".concat(iframeHeight, "px")
          }
        }) : createElement(Scrollable$1, {
          shadow: true,
          className: styles$V.Body,
          onScrolledToBottom: onScrolledToBottom
        }, body);
        var headerMarkup = title ? createElement(Header$1, {
          id: this.headerId,
          onClose: onClose
        }, title) : createElement(CloseButton, {
          onClick: onClose,
          title: false
        });
        dialog = createElement(Dialog, {
          ...
          className: styles$V.BodyWrapper
        }, bodyMarkup), footerMarkup);
        backdrop = createElement(Backdrop, null);
      }
...
function (_React$PureComponent) {
  ...
  _createClass(ContextualSaveBar, [{
    ...
    value: function render() {
      ...
      var discardConfirmationModalMarkup = discardAction && discardAction.onAction && discardAction.discardConfirmationModal && createElement(DiscardConfirmationModal$1, {
        open: discardConfirmationModalVisible,
        onCancel: this.toggleDiscardConfirmationModal,
        onDiscard: discardAction.onAction
      });
      var discardActionMarkup = discardAction && createElement(Button$1, {
      ...
      var saveActionMarkup = saveAction && createElement(Button$1, {
        primary: true,
        url: saveAction.url,
      ...
      var width = getWidth(logo, 104);
      var imageMarkup = logo && createElement(Image, {
        style: {
          width: width
        },
      ...
      var logoMarkup = alignContentFlush ? null : createElement("div", {
      ...
      return createElement(Fragment, null, createElement("div", {
        className: styles$W.ContextualSaveBar
      }, logoMarkup, createElement("div", {
        className: styles$W.Contents
      }, createElement("h2", {
        className: styles$W.Message
      }, message), createElement(Stack, {
        spacing: "tight",
        wrap: false
  ...
  _createClass(Frame, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          intl = _this$props.polaris.intl;
      var navClassName = classNames(styles$X.Navigation, showMobileNavigation && styles$X['Navigation-visible']);
      ...
      var navigationMarkup = navigation ? createElement(TrapFocus, {
      ...
      }, navigation, createElement("button", {
        type: "button",
        className: styles$X.NavigationDismiss,
      ...
      var loadingMarkup = loadingStack > 0 ? createElement("div", {
        className: styles$X.LoadingBar,
        id: APP_FRAME_LOADING_BAR
      }, createElement(Loading, null)) : null;
      var contextualSaveBarMarkup = createElement(CSSTransition, {
        appear: true,
        exit: true,
      ...
      }, createElement(ContextualSaveBar$1, this.contextualSaveBar)));
      var topBarMarkup = topBar ? createElement("div", Object.assign({
        className: styles$X.TopBar
      }, layer.props, dataPolarisTopBar.props, {
        id: APP_FRAME_TOP_BAR
      }), topBar) : null;
      var globalRibbonMarkup = globalRibbon ? createElement("div", {
        className: styles$X.GlobalRibbonContainer,
        ref: this.setGlobalRibbonContainer
      }, globalRibbon) : null;
      var skipClassName = classNames(styles$X.Skip, skipFocused && styles$X.focused);
      var skipMarkup = createElement("div", {
      ...
      var frameClassName = classNames(styles$X.Frame, navigation && styles$X.hasNav, topBar && styles$X.hasTopBar);
      var navigationOverlayMarkup = showMobileNavigation && mobileView ? createElement(Backdrop, {
      ...
      }, layer.props, navigationAttributes), skipMarkup, createElement(Provider$1, {
        mobileView: mobileView || false
      }, topBarMarkup, navigationMarkup), contextualSaveBarMarkup, loadingMarkup, navigationOverlayMarkup, createElement("main", {
        className: styles$X.Main,
        id: APP_FRAME_MAIN,
        "data-has-global-ribbon": Boolean(globalRibbon)
      }, createElement("div", {
        className: styles$X.Content
      }, children)), createElement(ToastManager, {
        toastMessages: toastMessages
      }), globalRibbonMarkup, createElement(EventListener, {
        event: "resize",
...
var navTransitionClasses = {
  enter: classNames(styles$X['Navigation-enter']),
  enterActive: classNames(styles$X['Navigation-enterActive']),
  enterDone: classNames(styles$X['Navigation-enterActive']),
  exit: classNames(styles$X['Navigation-exit']),
  exitActive: classNames(styles$X['Navigation-exitActive'])
};
var contextualSaveBarTransitionClasses = {
  enter: classNames(styles$X['ContextualSaveBar-enter']),
  enterActive: classNames(styles$X['ContextualSaveBar-enterActive']),
  enterDone: classNames(styles$X['ContextualSaveBar-enterActive']),
  exit: classNames(styles$X['ContextualSaveBar-exit']),
  exitActive: classNames(styles$X['ContextualSaveBar-exitActive'])
};
...
function Cell(_ref) {
  ...
  var className = classNames(styles$Y.Cell, fixed && styles$Y['Cell-fixed'], fixed && truncate && styles$Y['Cell-truncated'], header && styles$Y['Cell-header'], total && styles$Y['Cell-total'], footer && styles$Y['Cell-footer'], numeric && styles$Y['Cell-numeric'], sortable && styles$Y['Cell-sortable'], sorted && styles$Y['Cell-sorted']);
  var headerClassName = classNames(header && styles$Y.Heading, header && contentType === 'text' && styles$Y['Heading-left']);
  var iconClassName = classNames(sortable && styles$Y.Icon);
  var style = {
    height: height ? "".concat(height, "px") : undefined
  };
  var direction = sorted ? sortDirection : defaultSortDirection;
  var source = direction === 'ascending' ? CaretUpMinor : CaretDownMinor;
  ...
  var iconMarkup = createElement("span", {
    className: iconClassName
  }, createElement(Icon$1, {
    source: source,
    accessibilityLabel: sortAccessibilityLabel
  }));
  var sortableHeadingContent = createElement("button", {
    className: headerClassName,
    onClick: onSort
  }, iconMarkup, content);
  var columnHeadingContent = sortable ? sortableHeadingContent : content;
  var headingMarkup = header ? createElement("th", Object.assign({}, headerCell.props, {
    className: className,
    scope: "col",
    "aria-sort": sortDirection,
    style: style
  }), columnHeadingContent) : createElement("th", {
    className: className,
    scope: "row",
    style: style
  }, content);
  var cellMarkup = header || fixed ? headingMarkup : createElement("td", {
    className: className,
    style: style
  }, content);
  return cellMarkup;
...
function Navigation(_ref) {
  ...
  var pipMarkup = columnVisibilityData.map(function (column, index) {
    var className = classNames(styles$Y.Pip, column.isVisible && styles$Y['Pip-visible']);
    return createElement("div", {
      className: className,
  ...
  }), pipMarkup, createElement(Button$1, {
    plain: true,
...
function (_React$PureComponent) {
  ...
  function DataTable(props) {
    ...
    _this.dataTable = createRef();
    _this.scrollContainer = createRef();
    ...
    _this.defaultRenderRow = function (row, index) {
      var className = classNames(styles$Y.TableRow);
      var _this$props3 = _this.props,
  ...
  _createClass(DataTable, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$Y.DataTable, collapsed && styles$Y.collapsed, footerContent && styles$Y.hasFooter);
      var wrapperClassName = classNames(styles$Y.TableWrapper, collapsed && styles$Y.collapsed);
      var footerClassName = classNames(footerContent && styles$Y.TableFoot);
      var footerMarkup = footerContent ? createElement("tfoot", {
        className: footerClassName
      }, createElement("tr", null, this.renderFooter())) : null;
      var totalsMarkup = totals ? createElement("tr", null, totals.map(this.renderTotals)) : null;
      var headingMarkup = createElement("tr", null, headings.map(function (heading, headingIndex) {
        ...
        return createElement(Cell$1, Object.assign({
          header: true,
          key: id,
          height: height,
          content: heading,
      ...
      return createElement("div", {
        ...
        className: styles$Y.ScrollContainer,
        ...
        ref: this.table
      }, createElement("thead", null, headingMarkup, totalsMarkup), createElement("tbody", null, bodyMarkup), footerMarkup))));
    }
  }]);
  ...
  _createClass(Day, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          onHover = _this$props$onHover === void 0 ? noop$7 : _this$props$onHover,
          _this$props$onFocus = _this$props.onFocus,
          onFocus = _this$props$onFocus === void 0 ? noop$7 : _this$props$onFocus,
          selected = _this$props.selected,
      ...
      if (!day) {
        return createElement("div", {
          className: styles$Z.EmptyDay,
          onMouseOver: handleHover
        });
      }

      var handleClick = onClick && !disabled ? onClick.bind(null, day) : noop$7;
      var today = isSameDay(new Date(), day);
      var className = classNames(styles$Z.Day, selected && styles$Z['Day-selected'], disabled && styles$Z['Day-disabled'], today && styles$Z['Day-today'], (inRange || inHoveringRange) && !disabled && styles$Z['Day-inRange']);
...
function Weekday(_ref) {
  ...
  var className = classNames(styles$Z.Weekday, current && styles$Z['Weekday-current']);
  return createElement("div", {
...
function Month(_ref) {
  var focusedDate = _ref.focusedDate,
      ...
      onHover = _ref$onHover === void 0 ? noop$8 : _ref$onHover,
      _ref$onFocus = _ref.onFocus,
      onFocus = _ref$onFocus === void 0 ? noop$8 : _ref$onFocus,
      month = _ref.month,
      year = _ref.year,
  ...
  var weeksMarkup = weeks.map(function (week, index) {
    return createElement("div", {
      role: "row",
      className: styles$Z.Week,
      key: index
    }, week.map(renderWeek));
  });
  return createElement("div", {
    role: "grid",
    className: styles$Z.Month
  }, createElement("div", {
    className: className
  }, intl.translate("Polaris.DatePicker.months.".concat(monthName(month))), " ", year), createElement("div", {
    role: "rowheader",
    className: styles$Z.WeekHeadings
...
function (_React$PureComponent) {
  ...
  function DatePicker() {
    ...
    _this.handleDateSelection = function (range) {
      ...
      var _this$props$onChange = _this.props.onChange,
          onChange = _this$props$onChange === void 0 ? noop$9 : _this$props$onChange;
  ...
  _createClass(DatePicker, [{
    ...
    value: function render() {
      ...
      var secondDatePicker = multiMonth ? createElement(Month$1, {
        onFocus: this.handleFocus,
      ...
      return createElement("div", {
        ...
        className: styles$Z.MonthContainer
      }, createElement(Month$1, {
        onFocus: this.handleFocus,
        focusedDate: focusDate,
        month: month,
        year: year,
...
function DescriptionList(_ref) {
  ...
  var terms = items.reduce(function (allTerms, _ref2) {
    ...
    return [].concat(_toConsumableArray(allTerms), [createElement("dt", {
      key: getUniqueTermKey(),
      className: styles$_.Term
    }, term), createElement("dd", {
      key: getUniqueDescriptionKey(),
      className: styles$_.Description
    }, description)]);
  }, []);
  return createElement("dl", {
    className: styles$_.DescriptionList
  }, terms);
}
...
function (_React$Component) {
  ...
  _createClass(FileUpload, null, [{
    key: "getDerivedStateFromProps",
    value: function getDerivedStateFromProps(_ref, _ref2) {
      var nextActionTitle = _ref.actionTitle,
          nextActionHint = _ref.actionHint,
          translate = _ref.polaris.intl.translate,
          type = _ref.context.type;
      var actionTitle = _ref2.actionTitle,
          actionHint = _ref2.actionHint;
      var hasActionTitleChanged = nextActionTitle !== actionTitle;
      var hasActionHintChanged = nextActionHint !== actionHint;
      ...
      return {
        actionTitle: nextActionTitle && hasActionTitleChanged ? nextActionTitle : translate("Polaris.DropZone.FileUpload.actionTitle".concat(suffix)),
        actionHint: nextActionHint && hasActionHintChanged ? nextActionHint : translate("Polaris.DropZone.FileUpload.actionHint".concat(suffix))
      };
    }
  }]);
  ...
  function FileUpload(props) {
    ...
    var suffix = capitalize(type);
    _this.state = {
      actionTitle: translate("Polaris.DropZone.FileUpload.actionTitle".concat(suffix)),
      actionHint: translate("Polaris.DropZone.FileUpload.actionHint".concat(suffix))
    };
    return _this;
  }
  ...
  _createClass(FileUpload, [{
    ...
    value: function render() {
      ...
      var extraLargeView = size === 'extraLarge' ? createElement(Stack, {
        vertical: true
      }, type === 'file' && createElement("img", {
        className: imageClasses,
        src: fileUpload,
        alt: ""
      }), type === 'image' && createElement("img", {
        className: imageClasses,
        src: imageUpload,
        alt: ""
      }), createElement(Button$1, null, actionTitle), createElement(TextStyle, {
        variation: "subdued"
      }, actionHint)) : null;
      var largeView = size === 'large' ? createElement(Stack, {
        vertical: true,
        spacing: "tight"
      }, type === 'file' && createElement("img", {
        className: imageClasses,
        ...
        size: "slim"
      }, actionTitle), createElement(Caption, null, createElement(TextStyle, {
        variation: "subdued"
      }, actionHint))) : null;
      var mediumView = size === 'medium' ? createElement(Stack, {
        vertical: true,
        spacing: "tight"
      }, createElement(Link$2, null, actionTitle), createElement(Caption, null, createElement(TextStyle, {
        variation: "subdued"
      }, actionHint))) : null;
      var smallView = size === 'small' ? createElement(Stack, {
        vertical: true,
        spacing: "tight"
      }, createElement(Icon$1, {
...
var FileUpload$1 = compose$1(withContext(Consumer$1), withAppProvider(), withRef())(FileUpload);
...
var getUniqueID$8 = createUniqueIDFactory('DropZone');
var DropZone =
/*#__PURE__*/
function (_React$Component) {
  ...
  _createClass(DropZone, [{
    ...
    value: function render() {
      ...
      var classes = classNames(styles$10.DropZone, outline && styles$10.hasOutline, (active || dragging) && styles$10.isDragging, error && styles$10.hasError, size && size === 'extraLarge' && styles$10.sizeExtraLarge, size && size === 'large' && styles$10.sizeLarge, size && size === 'medium' && styles$10.sizeMedium, size && size === 'small' && styles$10.sizeSmall);
      var dragOverlay = (active || dragging) && !error && overlay ? createElement("div", {
        className: styles$10.Overlay
      }, createElement(Stack, {
        vertical: true,
        spacing: "tight"
      }, createElement(Icon$1, {
        source: DragDropMajorMonotone,
        color: "indigo"
      }), size === 'extraLarge' && createElement(DisplayText, {
        size: "small",
        element: "p"
      }, overlayText), (size === 'medium' || size === 'large') && createElement(Caption, null, overlayText))) : null;
      var dragErrorOverlay = dragging && error ? createElement("div", {
        className: styles$10.Overlay
      }, createElement(Stack, {
        vertical: true,
        spacing: "tight"
        ...
        size: "small",
        element: "p"
      }, errorOverlayText), (size === 'medium' || size === 'large') && createElement(Caption, null, errorOverlayText))) : null;
      var dropZoneMarkup = createElement("div", {
        ref: this.node,
        className: classes,
        "aria-disabled": disabled,
        onClick: this.handleClick,
        onDragStart: handleDragStart
      }, dragOverlay, dragErrorOverlay, createElement("div", {
        className: styles$10.Container
      }, children), createElement(VisuallyHidden, null, createElement("input", inputAttributes)));
      var labelledDropzoneMarkup = label ? createElement(Labelled, {
        id: id,
        label: label,
        action: labelAction,
        labelHidden: labelHidden
      }, dropZoneMarkup) : dropZoneMarkup;
      return createElement(Provider$2, {
...
function (_React$PureComponent) {
  ...
  _createClass(EmptySearchResult, [{
    ...
    value: function render() {
      ...
      var descriptionMarkup = description ? createElement("p", null, description) : null;
      var illustrationMarkup = withIllustration ? createElement(Image, {
        alt: altText,
        source: emptySearch,
      ...
      return createElement(Stack, {
        alignment: "center",
        vertical: true
      }, illustrationMarkup, createElement(DisplayText, {
        size: "small"
      }, title), createElement(TextStyle, {
        variation: "subdued"
      }, descriptionMarkup));
    }
  }]);
  ...
  _createClass(EmptyState, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          secondaryAction = _this$props.secondaryAction,
          footerContent = _this$props.footerContent;
      var className = classNames(styles$12.EmptyState, imageContained && styles$12.imageContained);
      var imageMarkup = largeImage ? createElement(Image, {
        alt: "",
        role: "presentation",
        className: styles$12.Image,
        source: largeImage,
        sourceSet: [{
          source: image,
          descriptor: '568w'
      ...
      var footerContentMarkup = footerContent ? createElement("div", {
        className: styles$12.FooterContent
      }, createElement(TextContainer, null, footerContent)) : null;
      return createElement("div", {
        className: className
      }, createElement("div", {
        className: styles$12.Section
      }, createElement("div", {
        className: styles$12.DetailsContainer
      }, createElement("div", {
        className: styles$12.Details
      }, createElement(TextContainer, null, createElement(DisplayText, {
        size: "medium"
      }, heading), createElement("div", {
        className: styles$12.Content
      }, children)), createElement("div", {
        className: styles$12.Actions
      }, createElement(Stack, {
        alignment: "center"
      }, buttonFrom(action, {
        primary: true,
        size: 'large'
      }), secondaryActionMarkup)), footerContentMarkup)), createElement("div", {
        className: styles$12.ImageContainer
      }, imageMarkup)));
    }
  }]);
...
function ExceptionList(_ref) {
  ...
  var items = itemsList.map(function (item, index) {
    ...
    var itemClasses = classNames(styles$14.Item, status && styles$14[variationName('status', status)]);
    var iconMarkup = icon ? createElement(Icon$1, {
      source: icon
    }) : createElement("span", {
      className: styles$14.Bullet
    });
    var titleMarkup = title && createElement("span", {
      className: styles$14.Title
    }, title);
    var descriptionMarkup = description && createElement("span", {
      className: styles$14.Description
    }, description);
    var Element = truncate ? Truncate : Fragment;
    return createElement("li", {
      className: itemClasses,
      key: index
    }, createElement("span", {
      className: styles$14.Icon
    }, iconMarkup), createElement(Element, null, titleMarkup, descriptionMarkup));
  });
  return createElement("ul", {
    className: styles$14.ExceptionList
  }, items);
}
...
function FooterHelp(_ref) {
  var children = _ref.children;
  return createElement("div", {
    className: styles$15.FooterHelp
  }, createElement("div", {
    className: styles$15.Content
  }, createElement("div", {
    className: styles$15.Icon
  }, createElement(Icon$1, {
    source: QuestionMarkMajorTwotone,
    color: "teal",
    backdrop: true
  })), createElement("div", {
    className: styles$15.Text
  }, children)));
}
...
function (_React$PureComponent) {
  ...
  _createClass(Form, [{
    ...
    value: function render() {
      ...
      var submitMarkup = implicitSubmit ? createElement(VisuallyHidden, null, createElement("button", {
        type: "submit",
        "aria-hidden": "true"
      })) : null;
...
function Item$4(props) {
  return createElement("div", {
    className: styles$16.Item
  }, props.children);
}

var getUniqueID$9 = createUniqueIDFactory('FormLayoutGroup');
function Group(_ref) {
  var children = _ref.children,
      condensed = _ref.condensed,
      title = _ref.title,
      helpText = _ref.helpText;
  var className = classNames(condensed ? styles$16.condensed : styles$16.grouped);
  ...
  if (helpText) {
    ...
    helpTextElement = createElement("div", {
      id: helpTextID,
      className: styles$16.HelpText
    }, helpText);
  }
...
function (_React$PureComponent) {
  ...
  _createClass(FormLayout, [{
    ...
    value: function render() {
      var children = this.props.children;
      return createElement("div", {
        className: styles$16.FormLayout
...
function KeyboardKey(_ref) {
  ...
  return createElement("kbd", {
    className: styles$17.KeyboardKey
  }, key);
}
...
function AnnotatedSection(props) {
  ...
  var descriptionMarkup = typeof description === 'string' ? createElement("p", null, description) : description;
  return createElement("div", {
    className: styles$18.AnnotatedSection
  }, createElement("div", {
    className: styles$18.AnnotationWrapper
  }, createElement("div", {
    className: styles$18.Annotation
  }, createElement(TextContainer, null, createElement(Heading, null, title), descriptionMarkup && createElement("div", {
    className: styles$18.AnnotationDescription
  }, descriptionMarkup))), createElement("div", {
    className: styles$18.AnnotationContent
  }, children)));
}
...
function Section$4(_ref) {
  ...
  var className = classNames(styles$18.Section, secondary && styles$18['Section-secondary'], fullWidth && styles$18['Section-fullWidth'], oneHalf && styles$18['Section-oneHalf'], oneThird && styles$18['Section-oneThird']);
  return createElement("div", {
    className: className
  }, children);
}
  ...
  _createClass(Layout, [{
    ...
    value: function render() {
      var _this$props = this.props,
          children = _this$props.children,
          sectioned = _this$props.sectioned;
      var content = sectioned ? createElement(Section$4, null, children) : children;
      return createElement("div", {
        className: styles$18.Layout
      }, content);
    }
  }]);
...
function (_React$PureComponent) {
  ...
  _createClass(ContentList, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$19.List, type && styles$19[variationName('type', type)]);
      var ListElement = type === 'bullet' ? 'ul' : 'ol';
      return createElement(ListElement, {
        className: className
      }, children);
    }
  }]);
  ...
  _createClass(Loading, [{
    ...
    value: function componentDidMount() {
      ...
      if (appBridge == null) {
        ...
        this.appBridgeLoading = Loading$3.create(appBridge);
        this.appBridgeLoading.dispatch(Loading$3.Action.START);
      }
    }
  }, {
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
      ...
      if (appBridge == null) {
        ...
        this.appBridgeLoading.dispatch(Loading$3.Action.STOP);
      }
    }
  }, {
    key: "render",
...
var contextTypes$2 = Object.assign({
  location: string,
  onNavigationDismiss: func
}, contentContextTypes);
...
function Indicator(_ref) {
  ...
  var className = classNames(styles$1a.Indicator, pulse && styles$1a.pulseIndicator);
  return createElement("span", {
    className: className
  });
}
...
function Secondary(_ref) {
  ...
  return createElement(Collapsible$1, {
    id: secondaryNavigationId,
    open: expanded
  }, createElement("ul", {
    className: styles$1b.List
  }, children));
}
...
function (_React$Component) {
  ...
  _createClass(BaseItem, [{
    ...
    value: function render() {
      ...
      var indicatorMarkup = hasNewChild ? createElement("span", {
      ...
      var iconMarkup = iconBodyOrIcon ? createElement("div", {
      ...
      if (isNew) {
        badgeMarkup = createElement(Badge$1, {
          status: "new",
          size: "small"
      ...
      var wrappedBadgeMarkup = badgeMarkup == null ? null : createElement("div", {
        className: styles$1b.Badge
      }, badgeMarkup);
      var itemContentMarkup = createElement(Fragment, null, iconMarkup, createElement("span", {
        className: styles$1b.Text
      }, label, indicatorMarkup), wrappedBadgeMarkup);

      if (url == null) {
        var _className = classNames(styles$1b.Item, disabled && styles$1b['Item-disabled']);

        return createElement("li", {
          className: styles$1b.ListItem
        }, createElement("button", {
          type: "button",
      ...
      var secondaryActionMarkup = secondaryAction && createElement(UnstyledLink$1, {
        external: true,
        url: secondaryAction.url,
        className: styles$1b.SecondaryAction,
        tabIndex: tabIndex,
        "aria-disabled": disabled,
      ...
      var itemClassName = classNames(styles$1b.Item, disabled && styles$1b['Item-disabled'], selected && subNavigationItems.length === 0 && styles$1b['Item-selected'], showExpanded && styles$1b.subNavigationActive);
      ...
      if (subNavigationItems.length > 0 && showExpanded) {
        ...
        secondaryNavigationMarkup = createElement("div", {
          className: styles$1b.SecondaryNavigation
        }, createElement(Secondary, {
          expanded: showExpanded
        }, subNavigationItems.map(function (item) {
          var label = item.label,
              rest = __rest(item, ["label"]);

          return createElement(Item$6, Object.assign({}, rest, {
            key: label,
            label: label,
      ...
      var className = classNames(styles$1b.ListItem, secondaryAction && styles$1b['ListItem-hasAction']);
      return createElement("li", {
        className: className
      }, createElement(UnstyledLink$1, {
        url: url,
...
function (_React$Component) {
  ...
  _createClass(Section, [{
    ...
    value: function render() {
      ...
      var expanded = this.state.expanded;
      var className = classNames(styles$1b.Section, separator && styles$1b['Section-withSeparator'], fill && styles$1b['Section-fill']);
      var actionMarkup = action && createElement("button", {
        type: "button",
        className: styles$1b.Action,
        "aria-label": action.accessibilityLabel,
        onClick: action.onClick
      }, createElement(Icon$1, {
        source: action.icon
      }));
      var sectionHeadingMarkup = title && createElement("li", {
        className: styles$1b.SectionHeading
      }, createElement("span", {
        className: styles$1b.Text
      }, title), actionMarkup);
      ...
      var toggleClassName = classNames(styles$1b.Item, styles$1b.RollupToggle);
      var ariaLabel = rollup && (expanded ? rollup.hide : rollup.view);
      var toggleRollup = rollup && items.length > rollup.after && createElement("div", {
        className: styles$1b.ListItem,
        key: "List Item"
      }, createElement("button", {
        type: "button",
      ...
      var activeItemsMarkup = rollup && additionalItems.length > 0 && createElement("li", {
        className: styles$1b.RollupSection
      }, createElement(Collapsible$1, {
...
function (_React$Component) {
  ...
  _createClass(UserMenu, [{
    ...
    value: function render() {
      ...
      return createElement(UserMenuModifier, {
  ...
  _createClass(Navigation, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          userMenu = _this$props.userMenu,
          contextControl = _this$props.contextControl;
      var contextControlMarkup = contextControl && createElement("div", {
        className: styles$1b.ContextControl
      }, contextControl);
      return createElement("nav", {
        className: styles$1b.Navigation
      }, contextControlMarkup, createElement("div", {
        className: styles$1b.UserMenu
      }, userMenu), createElement(Scrollable$1, {
        className: styles$1b.PrimaryNavigation
      }, children));
    }
  }]);
...
function (_React$PureComponent) {
  ...
  function TooltipOverlay() {
    ...
    _this.renderTooltip = function (overlayDetails) {
      ...
      var containerClassName = classNames(styles$1c.Tooltip, light && styles$1c.light, measuring && styles$1c.measuring, positioning === 'above' && styles$1c.positionedAbove);
      var contentStyles = measuring ? undefined : {
        minHeight: desiredHeight
      };
      return createElement("div", Object.assign({
        className: containerClassName
      }, layer.props), createElement("div", {
        className: styles$1c.Wrapper
      }, createElement("div", {
        id: id,
        role: "tooltip",
        className: styles$1c.Content,
        style: contentStyles
      }, children)));
    };
...
var getUniqueID$a = createUniqueIDFactory('TooltipContent');
...
function Pagination(_ref) {
  ...
  var className = classNames(styles$1d.Pagination, plain && styles$1d.plain);
  var previousClassName = classNames(styles$1d.Button, styles$1d.PreviousButton);
  var nextClassName = classNames(styles$1d.Button, styles$1d.NextButton);
  var previousButton = previousURL ? createElement(UnstyledLink$1, {
  ...
  var nextButton = nextURL ? createElement(UnstyledLink$1, {
  ...
  var constructedPrevious = previousTooltip ? createElement(Tooltip, {
    content: previousTooltip
  }, previousButton) : previousButton;
  var constructedNext = nextTooltip ? createElement(Tooltip, {
    content: nextTooltip
  }, nextButton) : nextButton;
  var previousButtonEvents = previousKeys && (previousURL || onPrevious) && hasPrevious && previousKeys.map(function (key) {
    return createElement(KeypressListener, {
      key: key,
      keyCode: key,
...
function Action(_ref) {
  var icon = _ref.icon,
      ...
      accessibilityLabel = _ref.accessibilityLabel,
      disabled = _ref.disabled;
  var iconMarkup = icon && createElement("span", {
    className: styles$1e.ActionIcon
  }, createElement(Icon$1, {
    source: icon
  }));
  var disclosureIconMarkup = disclosure && createElement("span", {
    className: styles$1e.ActionIcon
  }, createElement(Icon$1, {
    source: CaretDownMinor
  }));
  var contentMarkup = iconMarkup || disclosureIconMarkup ? createElement("span", {
    className: styles$1e.ActionContent
  }, iconMarkup, createElement("span", null, children), disclosureIconMarkup) : children;
  ...
  var className = classNames(styles$1e.Action, disabled && styles$1e.disabled, icon && children == null && styles$1e.iconOnly);
  return createElement("button", {
    key: children,
    className: className,
    onClick: onAction,
...
function (_React$Component) {
  ...
  _createClass(ActionGroup, [{
    ...
    value: function render() {
      ...
      var detailsMarkup = details && createElement("div", {
        className: styles$1f.Details
      }, details);
      return createElement("div", {
        className: styles$1f.ActionGroup,
        key: "ActionGroup-".concat(title)
      }, createElement(Popover, {
        key: title,
        active: active,
        onClose: this.handleClose,
        activator: createElement(Action, {
          disclosure: true,
          icon: icon,
...
function (_React$PureComponent) {
  ...
  function Header() {
    ...
    _this.renderRollupAction = function () {
      ...
      var rollupMarkup = _this.hasRollup ? createElement("div", {
        className: styles$1g.Rollup
      }, createElement(Popover, {
        active: rollupOpen,
        onClose: _this.handleRollupToggle,
        activator: createElement(Button$1, {
          plain: true,
    ...
    _this.renderSecondaryActions = function () {
      ...
      var actionGroupsMarkup = actionGroups.length > 0 ? actionGroups.map(function (_ref, index) {
        var title = _ref.title,
            ...
            details = _ref.details;
        return createElement("div", {
          className: styles$1g.IndividualAction,
          key: "ActionGroup-".concat(title, "-").concat(index)
        }, createElement(ActionGroup, {
          title: title,
          icon: icon,
          actions: actions,
          details: details,
      ...
      return createElement("div", {
        className: styles$1g.SecondaryActions
      }, createElement("div", {
        className: styles$1g.IndividualActions
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$1g.Header, titleHidden && styles$1g['Title-hidden'], pagination && styles$1g['Header-hasPagination'], separator && styles$1g['Header-hasSeparator'], breadcrumbs && breadcrumbs.length && styles$1g['Header-hasBreadcrumbs'], this.hasRollup && styles$1g['Header-hasRollup'], secondaryActions && secondaryActions.length && styles$1g['Header-hasSecondaryActions']);
      var breadcrumbMarkup = breadcrumbs.length > 0 ? createElement(Breadcrumbs, {
        breadcrumbs: breadcrumbs
      }) : null;
      var primary = primaryAction && (primaryAction.primary === undefined ? true : primaryAction.primary);
      var primaryActionMarkup = primaryAction ? createElement("div", {
        className: styles$1g.PrimaryAction
      }, buttonsFrom(primaryAction, {
        primary: primary
      })) : null;
      var paginationMarkup = pagination ? createElement("div", {
        className: styles$1g.Pagination
      }, createElement(Pagination$1, Object.assign({}, pagination, {
        plain: true
      }))) : null;
      var rollupMarkup = this.renderRollupAction();
      var nonPrimaryActionsMarkup = this.renderSecondaryActions();
      var actionsMarkup = primaryAction || secondaryActions || actionGroups ? createElement("div", {
        className: styles$1g.Actions
      }, nonPrimaryActionsMarkup, primaryActionMarkup) : null;
      var navigationMarkup = breadcrumbMarkup || paginationMarkup ? createElement("div", {
        className: styles$1g.Navigation
      }, breadcrumbMarkup, paginationMarkup, breadcrumbMarkup && rollupMarkup) : null;
      var titleMarkup = createElement("div", {
        className: styles$1g.TitleAndRollup
      }, createElement("div", {
        className: styles$1g.Title
      }, createElement("div", null, createElement(DisplayText, {
        size: "large",
        element: "h1"
      }, title)), createElement("div", null, titleMetadata)), !breadcrumbMarkup && rollupMarkup);
      return primaryActionMarkup ? createElement("div", {
        className: className
      }, navigationMarkup, createElement("div", {
        className: styles$1g.MainContent
      }, createElement("div", {
        className: styles$1g.TitleAndActions
      }, titleMarkup, actionsMarkup), primaryActionMarkup)) : createElement("div", {
        className: className
...
function secondaryActionsFrom(actions) {
  return actions.map(function (_a, index) {
    ...
    }, createElement(Action, action, content));
  });
}
...
function (_React$PureComponent) {
  ...
  _createClass(Page, [{
    ...
    value: function componentDidMount() {
      ...
      this.titlebar = TitleBar.create(this.props.polaris.appBridge, this.transformProps());
    }
  }, {
    key: "componentDidUpdate",
    value: function componentDidUpdate(prevProps) {
    ...
    value: function render() {
      ...
      var className = classNames(styles$1h.Page, fullWidth && styles$1h.fullWidth, singleColumn && styles$1h.singleColumn);
      var headerMarkup = this.delegateToAppbridge || this.hasHeaderContent() === false ? null : createElement(Header$3, rest);
      return createElement("div", {
        className: className
      }, headerMarkup, createElement("div", {
        className: styles$1h.Content
      }, children));
    }
  }, {
    ...
    value: function transformBreadcrumbs() {
      ...
      if (breadcrumbs != null && breadcrumbs.length > 0) {
        ...
        if (callback != null) {
          button.subscribe(Button$2.Action.CLICK, callback);
        }
...
function PageActions(_ref) {
  ...
  var secondaryActionsMarkup = secondaryActions ? createElement(ButtonGroup, null, buttonsFrom(secondaryActions)) : null;
  var distribution = secondaryActionsMarkup ? 'equalSpacing' : 'trailing';
  return createElement("div", {
    className: styles$1i.PageActions
  }, createElement(Stack, {
...
function (_React$Component) {
  ...
  function DualThumb() {
    ...
    _this.track = createRef();
    _this.trackWrapper = createRef();
    _this.thumbLower = createRef();
    _this.thumbUpper = createRef();
  ...
  _createClass(DualThumb, [{
    ...
    value: function render() {
      ...
      var ariaDescribedBy = describedBy.length ? describedBy.join(' ') : undefined;
      var trackWrapperClassName = classNames(styles$1j.TrackWrapper, error && styles$1j.error, disabled && styles$1j.disabled);
      var thumbLowerClassName = classNames(styles$1j.Thumbs, styles$1j.ThumbLower, disabled && styles$1j.disabled);
      var thumbUpperClassName = classNames(styles$1j.Thumbs, styles$1j.ThumbUpper, disabled && styles$1j.disabled);
      ...
      var outputLowerClassName = classNames(styles$1j.Output, styles$1j.OutputLower);
      var outputMarkupLower = !disabled && output ? createElement("output", {
        htmlFor: idLower,
        ...
        className: styles$1j.OutputBubble
      }, createElement("span", {
        className: styles$1j.OutputText
      }, value[0]))) : null;
      var outputUpperClassName = classNames(styles$1j.Output, styles$1j.OutputUpper);
      var outputMarkupUpper = !disabled && output ? createElement("output", {
        htmlFor: idUpper,
      ...
      var prefixMarkup = prefix && createElement("div", {
        className: styles$1j.Prefix
      }, prefix);
      var suffixMarkup = suffix && createElement("div", {
        className: styles$1j.Suffix
      }, suffix);
      return createElement(Fragment, null, createElement(Labelled, {
        id: id,
        label: label,
        error: error,
        action: labelAction,
        ...
        ref: this.thumbLower
      }), outputMarkupLower, createElement("button", {
        id: idUpper,
        ...
        ref: this.thumbUpper
      }), outputMarkupUpper), suffixMarkup)), createElement(EventListener, {
        event: "resize",
...
function SingleThumb(props) {
  ...
  var outputMarkup = !disabled && output && createElement("output", {
    htmlFor: id,
    className: styles$1k.Output
  }, createElement("div", {
    className: styles$1k.OutputBubble
  }, createElement("span", {
    className: styles$1k.OutputText
  }, clampedValue)));
  var prefixMarkup = prefix && createElement("div", {
    className: styles$1k.Prefix
  }, prefix);
  var suffixMarkup = suffix && createElement("div", {
    className: styles$1k.Suffix
  }, suffix);
  var className = classNames(styles$1k.SingleThumb, error && styles$1k.error, disabled && styles$1k.disabled);
  return createElement(Labelled, {
    id: id,
    label: label,
    error: error,
    ...
    className: styles$1k.InputWrapper
  }, createElement("input", {
    type: "range",
    className: styles$1k.Input,
    id: id,
    name: id,
    min: min,
    max: max,
...
var getUniqueID$b = createUniqueIDFactory('RangeSlider');
...
function (_React$Component) {
  ...
  _createClass(RangeSlider, [{
    ...
    value: function render() {
      ...
      var sliderType = isDualThumb(value) ? createElement(DualThumb, Object.assign({
        value: value
      }, sharedProps)) : createElement(SingleThumb, Object.assign({
        value: value
      }, sharedProps));
      return createElement("div", {
        className: styles$1l.RangeSliderContainer
      }, sliderType);
    }
  }]);
...
var getUniqueID$c = createUniqueIDFactory('Select');
function Select(_ref) {
  ...
  var className = classNames(styles$1m.Select, error && styles$1m.error, disabled && styles$1m.disabled);
  ...
  var inlineLabelMarkup = labelInline && createElement("span", {
    className: styles$1m.InlineLabel
  }, label);
  var selectedOption = getSelectedOption(normalizedOptions, value);
  var contentMarkup = createElement("div", {
    className: styles$1m.Content,
    "aria-hidden": true
  }, inlineLabelMarkup, createElement("span", {
    className: styles$1m.SelectedOption
  }, selectedOption), createElement("span", {
  ...
  return createElement(Labelled, {
    ...
    "aria-invalid": Boolean(error),
    "aria-describedby": describedBy.length ? describedBy.join(' ') : undefined
  }, optionsMarkup), contentMarkup, createElement("div", {
    className: styles$1m.Backdrop
  })));
}
...
function CheckableButton(_ref) {
  var accessibilityLabel = _ref.accessibilityLabel,
      ...
      disabled = _ref.disabled;
  var className = plain ? classNames(styles$1n.CheckableButton, styles$1n['CheckableButton-plain']) : classNames(styles$1n.CheckableButton, selectMode && styles$1n['CheckableButton-selectMode'], selected && styles$1n['CheckableButton-selected'], measuring && styles$1n['CheckableButton-measuring']);
  return createElement("div", {
    className: className,
    onClick: onToggleAll
  }, createElement("div", {
    className: styles$1n.Checkbox
  }, createElement(Checkbox$2, {
    label: accessibilityLabel,
    labelHidden: true,
    checked: selected,
    disabled: disabled,
  ...
  _createClass(BulkActionButton, [{
    ...
    value: function componentDidMount() {
      ...
      if (handleMeasurement) {
        var bulkActionButtonNode = findDOMNode(this);
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          disabled = _this$props.disabled;
      var disclosureIconMarkup = disclosure ? createElement("span", {
        className: styles$1o.ActionIcon
      }, createElement(Icon$1, {
        source: CaretDownMinor
      })) : null;
      var contentMarkup = disclosureIconMarkup ? createElement("span", {
        className: styles$1o.ActionContent
      }, createElement("span", null, content), disclosureIconMarkup) : content;
      ...
      var className = classNames(styles$1o.Button, disabled && styles$1o.disabled);
      return createElement("button", {
        className: className,
        onClick: onAction,
        onMouseUp: handleMouseUpByBlurring,
...
var slideClasses = {
  appear: classNames(styles$1o.Slide, styles$1o['Slide-appear']),
  appearActive: classNames(styles$1o.Slide, styles$1o['Slide-appearing']),
  enter: classNames(styles$1o.Slide, styles$1o['Slide-enter']),
  enterActive: classNames(styles$1o.Slide, styles$1o['Slide-entering']),
  exit: classNames(styles$1o.Slide, styles$1o['Slide-exit'])
};
var BulkActions =
/*#__PURE__*/
function (_React$PureComponent) {
  ...
  _createClass(BulkActions, [{
    ...
    value: function render() {
      ...
      var paginatedSelectAllActionMarkup = paginatedSelectAllAction ? createElement(Button$1, {
        onClick: paginatedSelectAllAction.onAction,
        plain: true,
        disabled: disabled
      }, paginatedSelectAllAction.content) : null;
      var paginatedSelectAllTextMarkup = paginatedSelectAllText && paginatedSelectAllAction ? createElement("span", {
        "aria-live": "polite"
      }, paginatedSelectAllText) : paginatedSelectAllText;
      var paginatedSelectAllMarkup = paginatedSelectAllActionMarkup || paginatedSelectAllTextMarkup ? createElement("div", {
        className: styles$1o.PaginatedSelectAll
      }, paginatedSelectAllTextMarkup, " ", paginatedSelectAllActionMarkup) : null;
      var cancelButtonClassName = classNames(styles$1o.Button, styles$1o['Button-cancel'], disabled && styles$1o.disabled);
      ...
      var allActionsPopover = this.hasActions ? createElement("div", {
        className: styles$1o.Popover,
        ref: this.setMoreActionsNode
      }, createElement(Popover, {
        active: smallScreenPopoverVisible,
        activator: createElement(BulkActionButton, {
          disclosure: true,
      ...
      var promotedActionsMarkup = promotedActions && numberOfPromotedActionsToRender > 0 ? _toConsumableArray(promotedActions).slice(0, numberOfPromotedActionsToRender).map(function (action, index) {
        return createElement(BulkActionButton, Object.assign({
          disabled: disabled
        }, action, {
          key: index,
      ...
      var actionsPopover = this.actionSections || rolledInPromotedActions.length > 0 || measuring ? createElement("div", {
        className: styles$1o.Popover,
        ref: this.setMoreActionsNode
      }, createElement(Popover, {
      ...
      var smallScreenGroup = createElement(Transition, {
        timeout: 0,
        "in": selectMode,
        key: "smallGroup"
      }, function (status) {
        var smallScreenGroupClassName = classNames(styles$1o.Group, styles$1o['Group-smallScreen'], styles$1o["Group-".concat(status)]);
        return createElement("div", {
          className: smallScreenGroupClassName
        }, createElement("div", {
          className: styles$1o.ButtonGroup
        }, createElement(CSSTransition, {
          "in": selectMode,
          timeout: durationBase,
          classNames: slideClasses,
          appear: true
        }, createElement(CheckableButton$1, checkableButtonProps)), allActionsPopover, cancelButton), paginatedSelectAllMarkup);
      });
      var largeScreenGroup = createElement(Transition, {
        timeout: 0,
        "in": selectMode,
        key: "largeGroup"
      }, function (status) {
        var largeScreenGroupClassName = classNames(styles$1o.Group, styles$1o['Group-largeScreen'], !measuring && styles$1o["Group-".concat(status)], measuring && styles$1o['Group-measuring']);
        return createElement("div", {
        ...
        }, createElement(CheckableButton$1, checkableButtonProps), promotedActionsMarkup, actionsPopover), paginatedSelectAllMarkup);
      });
      return createElement("div", {
...
function Tag(_ref) {
  var children = _ref.children,
      ...
      intl = _ref.polaris.intl;
  var className = classNames(disabled && styles$1p.disabled, styles$1p.Tag);
...
var _React$createContext$2 = createContext({
  selectMode: false,
  resourceName: {
...
function (_React$PureComponent) {
  ...
  _createClass(DateSelector, [{
    ...
    value: function render() {
      ...
      var datePredicateMarkup = showDatePredicate && createElement(Fragment, null, createElement("div", {
        className: styles$1q.DateTextField
        ...
        className: styles$1q.DatePicker
      }, createElement(DatePicker$1, {
      ...
      return createElement(Fragment, null, createElement(Select, {
...
function (_React$PureComponent) {
  ...
  _createClass(FilterValueSelector, [{
    ...
    value: function render() {
      ...
      var operatorOptionsMarkup = showOperatorOptions ? createElement(Select, {
        label: filter.label,
        labelHidden: true,
      ...
      switch (filter.type) {
        case FilterType.Select:
          return createElement(Stack, {
            vertical: true
          }, operatorOptionsMarkup, createElement(Select, {
        ...
        case FilterType.TextField:
          return createElement(Stack, {
            vertical: true
          }, operatorOptionsMarkup, createElement(TextField$1, {
            label: selectedFilterLabel,
            value: value,
        ...
        case FilterType.DateSelector:
          return createElement(DateSelector$1, {
...
function (_React$PureComponent) {
  ...
  _createClass(FilterCreator, [{
    ...
    value: function render() {
      ...
      var activator = createElement(Button$1, {
      ...
      var filterValueSelectionMarkup = selectedFilter ? createElement(FilterValueSelector$1, {
      ...
      var addFilterButtonMarkup = selectedFilter ? createElement(Button$1, {
      ...
      }, createElement(FormLayout, null, createElement(Select, {
...
function (_React$Component) {
  ...
  _createClass(FilterControl, [{
    ...
    value: function render() {
      ...
      var filterCreatorMarkup = filters.length > 0 ? createElement(FilterCreator$1, {
      ...
      var appliedFiltersMarkup = appliedFilters.map(function (appliedFilter) {
        ...
        return createElement("li", {
          className: styles$1r.AppliedFilter,
          key: filterId
        }, createElement(Tag$1, {
      ...
      var appliedFiltersWrapper = appliedFilters.length > 0 ? createElement("ul", {
        className: styles$1r.AppliedFilters
      }, appliedFiltersMarkup) : null;
      return createElement(FormLayout, null, createElement(TextField$1, {
...
var FilterControl$1 = compose$2(withAppProvider(), withContext(Consumer$2))(FilterControl);
...
function (_React$Component) {
  ...
  function Item() {
    ...
    _this.handleLargerSelectionArea = function (event) {
      ...
      _this.handleSelection(!_this.state.selected);
    };
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      ...
      if (selectable) {
        ...
        handleMarkup = createElement("div", {
          className: styles$1s.Handle,
          onClick: this.handleLargerSelectionArea
        }, createElement("div", {
          onClick: stopPropagation$1,
          className: styles$1s.CheckboxWrapper
        }, createElement(Checkbox$2, {
          id: this.checkboxId,
          label: label,
          labelHidden: true,
      ...
      if (media || selectable) {
        ownedMarkup = createElement("div", {
          className: styles$1s.Owned
        }, handleMarkup, mediaMarkup);
      }

      var className = classNames(styles$1s.Item, focused && styles$1s.focused, selectable && styles$1s.selectable, selected && styles$1s.selected, selectMode && styles$1s.selectMode, persistActions && styles$1s.persistActions, focusedInner && styles$1s.focusedInner);
      var actionsMarkup = null;
      var disclosureMarkup = null;

      if (shortcutActions && !loading) {
        if (persistActions) {
          actionsMarkup = createElement("div", {
            className: styles$1s.Actions,
            onClick: stopPropagation$1
          }, createElement(ButtonGroup, null, buttonsFrom(shortcutActions, {
            size: 'slim',
            plain: true
          })));
          disclosureMarkup = createElement("div", {
            className: styles$1s.Disclosure,
            onClick: stopPropagation$1
          }, createElement(Popover, {
            activator: createElement(Button$1, {
      ...
      var content = children ? createElement("div", {
        className: styles$1s.Content
      }, children) : null;
      var containerMarkup = createElement("div", {
        className: styles$1s.Container,
        id: this.props.id
      }, ownedMarkup, content, actionsMarkup, disclosureMarkup);
      var tabIndex = loading ? -1 : 0;
      var accessibleMarkup = url ? createElement(UnstyledLink$1, {
        "aria-describedby": this.props.id,
        "aria-label": accessibilityLabel,
        className: styles$1s.Link,
        url: url,
        tabIndex: tabIndex,
        id: this.overlayId
      }) : createElement("button", {
...
var Item$8 = compose$2(withContext(Consumer$2), withAppProvider())(Item$7);
...
var getUniqueID$d = createUniqueIDFactory('Select');
var ResourceList =
/*#__PURE__*/
function (_React$Component) {
  ...
  _createClass(ResourceList, [{
    ...
    value: function render() {
      ...
      var filterControlMarkup = filterControl ? createElement("div", {
        className: styles$1t.FiltersWrapper
      }, filterControl) : null;
      var bulkActionsMarkup = this.selectable ? createElement("div", {
        className: styles$1t.BulkActionsWrapper
      }, createElement(BulkActions$1, {
      ...
      var sortingLabelMarkup = createElement("label", {
        className: styles$1t.SortLabel,
        htmlFor: selectId
      }, intl.translate('Polaris.ResourceList.sortingLabel'));
      var sortingSelectMarkup = sortOptions && sortOptions.length > 0 && !alternateTool ? createElement("div", {
        className: styles$1t.SortWrapper
      }, sortingLabelMarkup, createElement(Select, {
      ...
      var alternateToolMarkup = alternateTool && !sortingSelectMarkup ? createElement("div", {
        className: styles$1t.AlternateToolWrapper
      }, alternateTool) : null;
      var headerTitleMarkup = createElement("div", {
        className: styles$1t.HeaderTitleWrapper
      }, this.headerTitle);
      var selectButtonMarkup = this.selectable ? createElement("div", {
      ...
      var checkableButtonMarkup = this.selectable ? createElement("div", {
        className: styles$1t.CheckableButtonWrapper
      }, createElement(CheckableButton$1, {
        accessibilityLabel: this.bulkActionsAccessibilityLabel,
      ...
      var headerWrapperOverlay = loading ? createElement("div", {
        className: styles$1t['HeaderWrapper-overlay']
      }) : null;
      var showEmptyState = filterControl && !this.itemsExist() && !loading;
      var headerMarkup = !showEmptyState && (showHeader || needsHeader) && this.listRef.current && createElement("div", {
        ...
        return createElement("div", {
          className: headerClassName
        }, headerWrapperOverlay, createElement("div", {
      ...
      var emptyStateMarkup = showEmptyState ? createElement("div", {
        className: styles$1t.EmptySearchResultWrapper
      }, createElement(EmptySearchResult$1, Object.assign({}, this.emptySearchResultText, {
      ...
      var loadingOverlay = loading ? createElement(Fragment, null, createElement("div", {
      ...
      var loadingWithoutItemsMarkup = loading && !this.itemsExist() ? createElement("div", {
        className: className,
        tabIndex: -1
      }, loadingOverlay) : null;
      var resourceListClassName = classNames(styles$1t.ResourceList, loading && styles$1t.disabledPointerEvents);
      var listMarkup = this.itemsExist() ? createElement("ul", {
        className: resourceListClassName,
        ref: this.listRef,
        "aria-live": "polite",
        "aria-busy": loading
      }, loadingOverlay, items.map(this.renderItem)) : emptyStateMarkup;
      return createElement(Provider$3, {
        value: this.getContext
      }, createElement("div", {
...
var BOTTOM_CLASS_NAMES = {
  enter: classNames(styles$1u.Bottom, styles$1u.enterBottom),
  enterActive: classNames(styles$1u.Bottom, styles$1u.enterBottomActive),
  exit: classNames(styles$1u.Bottom, styles$1u.exitBottom),
  exitActive: classNames(styles$1u.Bottom, styles$1u.exitBottomActive)
};
var RIGHT_CLASS_NAMES = {
  enter: classNames(styles$1u.Right, styles$1u.enterRight),
  enterActive: classNames(styles$1u.Right, styles$1u.enterRightActive),
  exit: classNames(styles$1u.Right, styles$1u.exitRight),
  exitActive: classNames(styles$1u.Right, styles$1u.exitRightActive)
};
var Sheet =
/*#__PURE__*/
function (_React$Component) {
  ...
  function Sheet() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Sheet).apply(this, arguments));
    _this.state = {
      mobile: false
    };
    _this.handleResize = debounce(function () {
      var _assertThisInitialize = _assertThisInitialized(_this),
          mobile = _assertThisInitialize.state.mobile,
  ...
  _createClass(Sheet, [{
    ...
    value: function render() {
      ...
      return createElement(Portal, {
        ...
        open: open
      }, children)), createElement(KeypressListener, {
        keyCode: Key.Escape,
        handler: onClose
      }), createElement(EventListener, {
        event: "resize",
        handler: handleResize
      }), open && createElement(Backdrop, {
        transparent: true,
        onClick: onClose
      }));
    }
...
function Container(props) {
  ...
  }, layer.props, overlay.props), createElement(TrapFocus, {
    trapping: props.open
  }, createElement("div", {
    role: "dialog",
    tabIndex: -1,
    className: styles$1u.Sheet
  }, props.children)));
}

var Sheet$1 = withAppProvider()(Sheet);
...
function (_React$PureComponent) {
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      ...
      var markup = url ? createElement(UnstyledLink$1, Object.assign({
        url: url
      }, sharedProps), children) : createElement("button", Object.assign({}, sharedProps, {
        type: "button"
      }), children);
      return createElement("li", {
        role: "presentation"
  ...
  _createClass(List, [{
    ...
    value: function render() {
      ...
      var tabs = disclosureTabs.map(function (_a, index) {
        ...
        return createElement(Item$9, Object.assign({}, tabProps, {
          key: id,
          id: id,
...
function (_React$PureComponent) {
  ...
  _createClass(Tab, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$1v.Tab, selected && styles$1v['Tab-selected']);
      var tabIndex;
      ...
      var markup = url ? createElement(UnstyledLink$1, {
        id: id,
        url: url,
        role: "tab",
        tabIndex: tabIndex,
...
function (_React$PureComponent) {
  ...
  function TabMeasurer() {
    ...
    _this.handleMeasurement = function () {
      ...
      var tabMeasurerNode = findDOMNode(_assertThisInitialized(_this));
  ...
  _createClass(TabMeasurer, [{
    ...
    value: function render() {
      ...
      var classname = classNames(styles$1v.Tabs, styles$1v.TabMeasurer);
      return createElement("div", {
        className: classname,
        ref: this.setContainerNode
      }, createElement(EventListener, {
...
function (_React$PureComponent) {
  ...
  function Tabs() {
    ...
    _this.handleFocus = function (event) {
      ...
      if (target.classList.contains(styles$1v.Tab) || target.classList.contains(styles$1v.Item)) {
        var tabToFocus = -1;
      ...
      if (target.classList.contains(styles$1v.DisclosureActivator)) {
        return;
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      var panelMarkup = children ? createElement(Panel, {
      ...
      var classname = classNames(styles$1v.Tabs, fitted && styles$1v.fitted, disclosureActivatorVisible && styles$1v.fillSpace);
      var disclosureTabClassName = classNames(styles$1v.DisclosureTab, disclosureActivatorVisible && styles$1v['DisclosureTab-visible']);
      var activator = createElement("button", {
        tabIndex: -1,
...
function Thumbnail(_ref) {
  var source = _ref.source,
      ...
      _ref$size = _ref.size,
      size = _ref$size === void 0 ? 'medium' : _ref$size;
  var className = classNames(styles$1w.Thumbnail, size && styles$1w[variationName('size', size)]);
  return createElement("span", {
    className: className
  }, createElement(Image, {
    alt: alt,
  ...
  _createClass(Toast, [{
    ...
    value: function componentDidMount() {
      ...
      if (appBridge == null) {
        ...
        this.appBridgeToast = Toast$3.create(appBridge, {
          message: content,
          duration: duration,
          isError: error
        });
        this.appBridgeToast.subscribe(Toast$3.Action.CLEAR, onDismiss);
        this.appBridgeToast.dispatch(Toast$3.Action.SHOW);
      }
    }
  }, {
    key: "componentWillUnmount",
...
function SkeletonDisplayText(_ref) {
  var _ref$size = _ref.size,
      size = _ref$size === void 0 ? 'medium' : _ref$size;
  var className = classNames(styles$1x.DisplayText, size && styles$1x[variationName('size', size)]);
  return createElement("div", {
    className: className
  });
}
...
function SkeletonBodyText(_ref) {
  ...
  for (var i = 0; i < lines; i++) {
    bodyTextLines.push(createElement("div", {
  ...
  _createClass(SkeletonPage, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          breadcrumbs = _this$props.breadcrumbs,
          intl = _this$props.polaris.intl;
      var className = classNames(styles$1z.Page, fullWidth && styles$1z.fullWidth, singleColumn && styles$1z.singleColumn);
      var headerClassName = classNames(styles$1z.Header, breadcrumbs && styles$1z['Header-hasBreadcrumbs'], secondaryActions && styles$1z['Header-hasSecondaryActions']);
      var titleMarkup = title !== null ? renderTitle(title) : null;
      var primaryActionMarkup = primaryAction ? createElement("div", {
        className: styles$1z.PrimaryAction
      }, createElement(SkeletonDisplayText, {
        size: "large"
      })) : null;
      var secondaryActionsMarkup = secondaryActions ? renderSecondaryActions(secondaryActions) : null;
      var breadcrumbMarkup = breadcrumbs ? createElement("div", {
        className: styles$1z.BreadcrumbAction,
        style: {
          width: 60
        }
      }, createElement(SkeletonBodyText, {
        lines: 1
      })) : null;
      var headerMarkup = !this.props.polaris.appBridge ? createElement("div", {
        className: headerClassName
      }, breadcrumbMarkup, createElement("div", {
...
function renderSecondaryActions(actionCount) {
  ...
  for (var i = 0; i < actionCount; i++) {
    ...
    actions.push(createElement("div", {
...
function renderTitle(title) {
  var titleContent = title === '' ? createElement(SkeletonDisplayText, {
    size: "large"
  }) : createElement(DisplayText, {
    size: "large",
    element: "h1"
...
function SkeletonThumbnail(_ref) {
  var _ref$size = _ref.size,
      size = _ref$size === void 0 ? 'medium' : _ref$size;
  var className = classNames(styles$1A.SkeletonThumbnail, size && styles$1A[variationName('size', size)]);
  return createElement("div", {
    className: className
  });
}
...
function ProgressBar(_ref) {
  var _ref$progress = _ref.progress,
      ...
      size = _ref$size === void 0 ? 'medium' : _ref$size,
      intl = _ref.polaris.intl;
  var className = classNames(styles$1B.ProgressBar, size && styles$1B[variationName('size', size)]);
...
export { AccountConnection, ActionList, AppProvider, Autocomplete$1 as Autocomplete, Avatar$1 as Avatar, Backdrop, Badge$1 as Badge, Banner, Breadcrumbs, Button$1 as Button, ButtonGroup, CalloutCard, Caption, Card, Checkbox$2 as Checkbox, ChoiceList$1 as ChoiceList, Collapsible$1 as Collapsible, ColorPicker, Connected, ContextualSaveBar$2 as ContextualSaveBar, DATA_ATTRIBUTE, DEFAULT_TOAST_DURATION, DEFAULT_TOAST_DURATION_WITH_ACTION, DataTable$1 as DataTable, DatePicker$1 as DatePicker, DescriptionList, DisplayText, DropZone$1 as DropZone, EmptySearchResult$1 as EmptySearchResult, EmptyState, EventListener, ExceptionList, FilterType, Focus, FooterHelp, Form, FormLayout, Frame$1 as Frame, Heading, Icon$1 as Icon, Image, Indicator, InlineError, Key, KeyboardKey, KeypressListener, Label, Labelled, Layout, Link$2 as Link, ContentList as List, Loading$2 as Loading, Modal$1 as Modal, Navigation$2 as Navigation, OptionList$1 as OptionList, Page$1 as Page, PageActions, Pagination$1 as Pagination, Popover, CloseSource as PopoverCloseSource, Portal, ProgressBar$1 as ProgressBar, RadioButton, RangeSlider$1 as RangeSlider, ResourceList$1 as ResourceList, ResourcePicker$1 as ResourcePicker, ScrollLock, Scrollable$1 as Scrollable, Select, SettingToggle, Sheet$1 as Sheet, SkeletonBodyText, SkeletonDisplayText, SkeletongBodyText as SkeletonPage, SkeletonThumbnail, Spinner$1 as Spinner, Stack, Sticky, Subheading, Tabs, Tag$1 as Tag, TextContainer, TextField$1 as TextField, TextStyle, ThemeProvider, Thumbnail, Toast$2 as Toast, Tooltip, TopBar$1 as TopBar, TrapFocus, Truncate, TypeOf, UnstyledLink$1 as UnstyledLink, VisuallyHidden, buttonFrom, buttonsFrom, contentContextTypes, createAppProviderContext, createPolarisContext, hsbToHex, hsbToRgb, isNavigationItemActive, polarisAppProviderContextTypes as polarisContextTypes, rgbString, rgbToHex, rgbToHsb, rgbToHsl, rgbaString, withAppProvider, withContext, withRef };
