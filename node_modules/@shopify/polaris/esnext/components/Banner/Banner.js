...
export default class Banner extends React.PureComponent {
    ...
    render() {
        const { icon, action, secondaryAction, title, children, status, onDismiss, } = this.props;
        ...
        tabIndex={0} ref={this.wrapper} role={ariaRoleType} aria-live="polite" onMouseUp={handleMouseUp} aria-labelledby={headingID} aria-describedby={contentID}>
        {dismissButton}
