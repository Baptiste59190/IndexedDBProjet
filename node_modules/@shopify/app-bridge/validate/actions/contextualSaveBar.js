...
exports.contextSaveBarSchema = type_validate_1.matchesObject({
    discardAction: type_validate_1.matchesObject({
    ...
    saveAction: type_validate_1.matchesObject({
        label: type_validate_1.matchesString(),
        disabled: type_validate_1.makeOptional(type_validate_1.matchesBoolean()),
    }),
...
function validateAction(action) {
    var validator = utils_1.createActionValidator(ContextualSaveBar_1.ActionType, exports.contextSaveBarSchema, true);
